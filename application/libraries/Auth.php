...
class Auth
{
    ...
    */
    function login_admin($username, $password, $remember=false){
        ...
        if (sizeof($result) > 0){
            ...
            $admin['admin']['user_role'] = $result['group_id'];
    ...
    */
    function save($admin)
    {
        ...
        {
            $this->CI->db->where('id', $admin['id']);
            $this->CI->db->update('login_users', $admin);
        }
        else
        {
            $this->CI->db->insert('login_users', $admin);
        }
    }
    ...
    */
    function get_admin_list()
    {
        ...
        $result = $this->CI->db->get('login_users');
