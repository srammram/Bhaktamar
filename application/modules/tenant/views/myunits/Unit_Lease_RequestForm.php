...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('owner/Myunits/unit_lease_request_form') ?>"> <?php echo lang('lease_request')?> </a></li>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('unit_request_form'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form method="post" action="<?php echo site_url('owner/Myunits/unit_lease_request_form/'.$requesttypid.'/'.$unitid.'/'.$id); ?>"
