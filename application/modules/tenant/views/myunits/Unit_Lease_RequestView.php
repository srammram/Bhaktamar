...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('owner/Myunits/unit_selfLease_request_form') ?>"> <?php echo lang('self_lease_request')?> </a></li>
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
						...
						<br>
						<br>
						<?php   if(isset($request->is_read_owner) && $request->is_read_owner ==2) { ?>
			...
			<span class="pull-right"><a href="<?php echo base_url('owner/Myunits/request_rejectByOwner').'/'.$request->id ?>"><button type="button" class="btn btn-danger btn-xs">Decline</button></a></span></p>
        </div>
    </div>
</fieldset>
<?php   }   ?>
