	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-xl-5 col-md-4 col-sm-4 col-xs-12">
				<div class="card" style="width: 100%;height: 436px;background-color: #2671ee;">
				  ...
				  <div class="card-body">
					...
					<a href="<?php echo site_url('owner/login/logout')?>" class="btn btn-primary btn_srd">Sign Out</a>
				  </div>
				</div>
			...
			<div class="col-xl-7 col-md-8 col-sm-8 col-xs-12">
				<div class="row">
				<a href="<?php echo site_url('owner/Myunits/unit_request_list')?>"><figure class="card_img">
					<div class="dashboardmessages"></div>
					<figcaption>Messages</figcaption>
				</figure></a>
				<a href="<?php echo site_url('owner/Myunits')?>"><figure class="card_img">
				...
				<a href="<?php echo site_url('owner/request/request_list')?>"><figure class="card_img">
