            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
					...
					<form method="post" action="<?php echo site_url('owner/Tenant/tenant_form/'.$id); ?>" enctype="multipart/form-data" id="tenantform">
					<div class="tab-content">
				     	<div class="tab-pane active" role="tabpanel" id="step1">
						<div class="form-group col-md-6">
                            <label for="unit"><?php echo lang('unit')?>:</label>
                            <select name="unit"  class="form-control chosen">
                                <option><?php echo lang('select')?></option>
                                <?php if(isset($ownerunits)){ foreach($ownerunits as $item) {		 ?>
                                <option value="<?php  echo $item->id ?>"
                                    <?php  if(isset($assigned_unit)){ echo $assigned_unit == $item->id ?'selected':'' ;  } ?>>
                                    <?php echo $item->unit_name .'(' . $item->floors .')'  ?></option>
                                <?php } }    ?>
                            </select>
                        </div>
							<div class="form-group col-md-6">
                            ...
                            <input type="text" name="fullname"
								...
								?>
                                  ...
                                  <div class="form-group col-sm-4">
											...
											<div class="col-sm-12">
												 <input type="text" name="resident_dob[]" class="form-control datepicker" width="100%" value="<?php echo $members->dob  ;?>" onkeydown="return false" />
											</div>
										</div>
                                   </div>
                                   <div class="row">
										<div class="form-group col-sm-4">
											...
											<div class="col-sm-12">
												 <input type="text" name="resident_age[]" class="form-control allowdecimalpoint" width="100%" value="<?php echo $members->age  ;?>" />
											</div>
										</div>
										<div class="form-group col-sm-4">
								...
								<div data-role="dynamic-fields">
								 ...
								 <div class="form-inline">
                                  ...
                                  <div class="form-group col-sm-4">
											<label class="control-label col-sm-12">DOB</label>
											<div class="col-sm-12">
												 <input type="text" name="resident_dob[]" class="form-control datepicker" width="100%" onkeydown="return false"  />
											</div>
										</div>
                                   </div>
                                   <div class="row">
										<div class="form-group col-sm-4">
											<label class="control-label col-sm-12">Age</label>
											<div class="col-sm-12">
												 <input type="text" name="resident_age[]" class="form-control allowdecimalpoint" width="100%" />
											</div>
										</div>
										<div class="form-group col-sm-4">
											<label class="control-label col-sm-12">Id Number</label>
