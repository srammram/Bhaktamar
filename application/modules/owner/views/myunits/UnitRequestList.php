                                ...
                                <td>
                                    <div class="btn-group" style="float:right">
                                        <a class="btn btn-default"
                                            href="<?php echo site_url('owner/Myunits/'.$new->view_link.'/'.$new->id); ?>"><i
                                                class="fa fa-eye"></i> <?php echo lang('view')?></a>
												<?php   if( $new->request_status ==lang('pending')){  ?>
                                        <a class="btn btn-primary"
                                            href="<?php echo site_url('owner/Myunits/'.$new->link.'/'.$new->request_type.'/'.$new->owner_realtion_unitid.'/'.$new->id); ?>"><i
