    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" action="<?php echo site_url('owner/request/request_form/'.$id); ?>"
					...
					<div class="form-group">
                            <div class="row">
							 <div class="col-md-2">
                               ...
                               <div class="col-md-3">
                                    <select name="ownerUnit_relationid" class="form-control" o>
                                        <option><?php echo lang('select')?></option>
                                        <?php 
								if(isset($OwnerUnits)){
									foreach($OwnerUnits as $row){
									?>
                                        <option value="<?php  echo $row->id   ?>"
                                            <?php  if(isset($unit_id->id)){ echo $unit_id->id == $row->id ?'selected':'' ;  } ?>>
