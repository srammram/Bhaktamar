    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a class="btn btn-success" href="<?php echo site_url('owner/request/request_form'); ?>"><i
                                ...
                                <td>
                                    <div class="btn-group" style="float:right">
                                        <a class="btn btn-default"
                                            href="<?php echo site_url('owner/request/request_view/'.$new->request_id); ?>"><i
                                                class="fa fa-eye"></i> <?php echo lang('view')?></a>
												<?php   if( $new->Complaint_status ==lang('Completed')){  ?>
                                        <a class="btn btn-primary"
                                            href="<?php echo site_url('owner/request/request_form/'.$new->request_id); ?>"><i
                                                class="fa fa-edit"></i> <?php echo lang('edit')?></a>
                                        <a class="btn btn-danger"
                                            href="<?php echo site_url('owner/request/requestDelete/'.$new->request_id); ?>"
