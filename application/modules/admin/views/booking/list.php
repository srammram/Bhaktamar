...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/booking/getbookings',
...
<div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="icon-layers"></i> Booking</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
       ...
       <div class="col-md-12">
        <div class="col-md-3">
            <div class="white-box bg-inverse p-t-10 p-b-10">
                <h3 class="box-title text-white">Total Booking</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="totalProjects" class="counter text-white">
					<?php  $booking=$this->db->get_where('booking',array('soft_delete'=>0))->result();
                            if(!empty($booking)){  echo count($booking) ;}else{ echo 0; }
                    ?></span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="white-box bg-success p-t-10 p-b-10">
                <h3 class="box-title text-white">Due Booking</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
        ...
        <div class="col-md-3">
            <div class="white-box p-t-10 p-b-10 bg-info">
                <h3 class="box-title text-white">Cancelled Booking</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="inProcessProjects" class="counter text-white">
                    <?php  $booking=$this->db->get_where('booking',array('soft_delete'=>1))->result();
                        if(!empty($booking)){  echo count($booking) ;}else{ echo 0; }
                        ?>
					</span></li>
                </ul>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group custom-action">
						<a href="<?php echo base_url('admin/booking/booking'); ?>" class="btn btn-outline btn-success btn-sm">New Booking <i class="fa fa-plus" aria-hidden="true"></i></a>
