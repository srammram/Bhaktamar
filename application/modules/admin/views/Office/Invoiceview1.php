	...
	<div class="row">
        <div class="col-xs-12">
    		...
    		<div class="invoice-title">
    			...
    			<h3 class="pull-right">Inv No #<p style="font-size:14px;"><?php if(isset($Invoicedetails->reservation_number)){ echo $Invoicedetails->reservation_number ;}else { echo '######';  }  ?></p></h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
