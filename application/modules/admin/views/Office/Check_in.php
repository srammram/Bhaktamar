...
<section class="content-header">
  <h1><?php echo $page_title; ?>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('Checkin'); ?></li>
          </ol>
</section>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php echo lang('Checkin'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
		...
		<tr>
			...
			<td>
				<div class="btn-group" style="float:right">
					...
					<a class="btn btn-success" href="<?php echo site_url('admin/Office/Edit/'.$new->id); ?>" ><i class="fa fa-location-arrow"></i> <?php echo lang('Checkin')?></a>
					<a class="btn btn-danger" style="margin-left:4px;" href="<?php echo site_url('admin/Office/cancel_booking/'.$new->id); ?>" onclick="return areyousureCancel(this);"><i class="fa fa-times-rectangle"></i> <?php echo lang('cancel')?></a>
				</div>
			</td>
		</tr>
<?php $i++; endforeach;?>
