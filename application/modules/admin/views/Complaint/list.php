         ...
         <div class="row">
		 	<div class="col-md-12">
				<div class="btn-group pull-right">
					<a class="btn btn-success" href="<?php echo site_url('admin/Complaint/form'); ?>"><i class="fa fa-plus"></i> Add </a>
				</div>
		...
		<tr>
			...
			<td>
				<div class="btn-group" style="float:right">
					...
					<a class="btn btn-danger" href="<?php echo site_url('admin/Complaint/delete/'.$new->complain_id); ?>" onclick="return areyousure(this);"><i class="fa fa-trash"></i> <?php echo lang('delete')?></a>
				</div>
			</td>
		</tr>
<?php $i++; endforeach;?>
