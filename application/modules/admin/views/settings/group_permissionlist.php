...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/settings/get_permission_list',
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('permission').' '.lang('list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_permission') ?></a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= lang('add_permission') ?></h4>
            </div>
...
<script>
    ...
    var table;
    var saveRow     = 'admin/settings/permission_add';
    var edit        = 'admin/settings/permission_update';
    var deleteRow   = 'admin/settings/permission_delete/';
    ...
    function edit_title(id){
        ...
        $.ajax({
            url : "<?php echo site_url('admin/settings/permission_edit/')?>/" + id,
            type: "GET",
            dataType: "JSON",
