...
<script>
    ...
    return  (x == 0 ) ? 'Active' : 'InActive';
        ...
        oTable = $('#UnitTable').dataTable({
            ...
            'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/settings/get_custom_plan/',
            'fnServerData': function (sSource, aoData, fnCallback) {
                $.ajax({'dataType': 'json', 'type': 'POST', 'url': sSource, 'data': aoData, 'success': fnCallback});
            },
            "aoColumns": [{"bSortable": false}, null,null,{"bSortable": false, "mRender": hl}, {"bSortable": false}]
        });
    }); 
</script>
<style>
...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('admin/settings/custom_plan') ?>"> <?php echo lang('custom_plan')?> </a></li>
          </ol>
</section>
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('custom_plan').' '.lang('list'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo base_url('admin/settings/custom_plan_form'); ?>" >
                                <i class="fa fa-plus"></i> <?= lang('add_custom_plan') ?>
                            </a>
                        </li>
