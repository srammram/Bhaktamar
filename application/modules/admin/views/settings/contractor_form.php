...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <form method="post" action="<?php echo site_url('admin/settings/contract_form/'.$contractor_id); ?>"
                        ...
                        <div class="box-body">
                            <div class="form-group col-md-6">
							 ...
							 <div class="form-group col-md-6">
                                <label for="email"><?php echo lang('contrator_type')?></label>
                                <input type="text" name="contrator_type" value="<?php  if(isset($con_type)){ echo $con_type ;  } ?>"
