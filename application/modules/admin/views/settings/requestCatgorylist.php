...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo lang('requestType_category'); ?></li>
    </ol>
</section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a class="btn btn-success" href="<?php echo site_url('admin/settings/request_categoryForm'); ?>"><i
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('requestType_category'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                                ...
                                <td>
                                    <div class="btn-group" style="float:right">
                                        <a class="btn btn-default"
                                            href="<?php echo site_url('admin/Settings/request_categoryView/'.$new->id); ?>"><i
                                                class="fa fa-eye"></i> <?php echo lang('view')?></a>
                                        <a class="btn btn-primary"
                                            href="<?php echo site_url('admin/Settings/request_categoryForm/'.$new->id); ?>"><i
                                                class="fa fa-edit"></i> <?php echo lang('edit')?></a>


                                        <a class="btn btn-danger"
                                            href="<?php echo site_url('admin/Settings/request_category_delete/'.$new->id); ?>"
