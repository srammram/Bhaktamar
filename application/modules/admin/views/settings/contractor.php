...
<script>
     $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
            ...
            'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/settings/get_contractor/',
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('contractor_list'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo base_url('admin/settings/contract_form'); ?>" >
                                <i class="fa fa-plus"></i> <?= lang('add_contractor') ?>
                            </a>
                        </li>
