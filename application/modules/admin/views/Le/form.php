...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('admin/Lease_Owner') ?>"> <?php echo lang('Lease_Owner')?> </a></li>
              ...
              <div class="box">
                <div class="box-body">
					<div class="box-header">
					  <h3 class="box-title"><?php echo lang('Lease_OwnerForm'); ?></h3>
					</div><!-- /.box-header -->
				<form method="post" action="<?php echo site_url('admin/Leaseowner/form/'.$id); ?>" enctype="multipart/form-data">	
