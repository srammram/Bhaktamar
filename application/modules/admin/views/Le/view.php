...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('admin/Leaseowner') ?>"><?php echo lang('Lease_Owner')?></a></li>
            <li class="active"><?php echo lang('view')?> <?php echo lang('Lease_Owner')?></li>
          </ol>
</section>
						...
						<div id="tab-1"> 
								<div class="form-group">
								  <div class="row">
									...
									<div class="col-md-6">
										<?php echo $leaseowner->firstname?> <?php echo $leaseowner->lastname?>
									</div>	
								  </div>		
								</div>
								<div class="form-group">
								  <div class="row">
									...
									<div class="col-md-6">
										<?php echo ($leaseowner->gender==1)?lang('male'):'';?> <?php echo ($leaseowner->gender==2)?lang('female'):'';?>
									</div>	
								  </div>		
								</div>
								<div class="form-group">
								  <div class="row">
									...
									<div class="col-md-6">
										<?php echo date_convert($leaseowner->dob);?>
									</div>	
								  </div>		
								</div>
								<div class="form-group">
								...
								<div class="form-group">
								  <div class="row">
									...
									<div class="col-md-3">
										<?php echo $leaseowner->id_type;?>
									</div>	
									<div class="col-md-2">
									<?php if(!empty($leaseowner->id_upload)){?>
										<a href="<?php echo base_url('assets/admin/uploads/ids/'.$leaseowner->id_upload); ?>" download class="btn btn-default"> <i class="fa fa-download"></i> <?php echo lang('download')?></a>
									<?php } ?>
									</div>
								  </div>		
								</div>
										...
										<tr>
											...
											<td align="right"width="45%" colspan="1"><?php echo lang('bill_to') ?><br />
												 <address>
													...
													<?php echo $new->leaseowner_address?><br>
													<?php echo $new->leaseowner_city?> <?php echo $new->leaseowner_state?>, <?php echo $new->leaseowner_country?><br>
													<?php echo lang('phone')?>: <?php echo $new->leaseowner_phone?><br/>
													<?php echo lang('email')?>: <?php echo $new->leaseowner_email?>
												  </address>
