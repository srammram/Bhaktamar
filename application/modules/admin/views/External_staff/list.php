...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/Ex_staff/get_externalStaff',
...
<h1>
         <?= lang('External_staff'); ?>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('External_staff'); ?></li>
          </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('External_staff').' '.lang('list'); ?></h2>
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                <li>
                                    <a href="<?php echo base_url('admin/Ex_staff/form'); ?>">
                                        <i class="fa fa-plus"></i> <?= lang('add_external_staff') ?>
                                    </a>
                                </li>
                            </ul>
                        </li>
