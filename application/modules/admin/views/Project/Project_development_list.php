            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php echo lang('Project_development'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
		...
		<tr>
			...
			<td>
				<div class="btn-group" style="float:right">
					<a class="btn btn-default" href="<?php echo site_url('admin/Project/ProjectDevelopment_view/'.$new->id); ?>"><i class="fa fa-eye"></i> <?php echo lang('view')?></a>
					<a class="btn btn-primary" href="<?php echo site_url('admin/Project/ProjectDevelopmentform/'.$new->id); ?>"><i class="fa fa-edit"></i> <?php echo lang('edit')?></a>
