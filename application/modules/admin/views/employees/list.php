         ...
         <div class="row">
		 	<div class="col-md-12" style="padding:20px;">
				<div class="btn-group pull-right">
					<a class="btn btn-success" href="<?php echo site_url('admin/employees/form'); ?>"><i class="fa fa-plus"></i> <?php echo lang('add');?></a>
				</div>
			</div>
		 </div>
		...
		<tr>
			...
			<td>
				<div class="btn-group" style="float:right">
					<a class="btn btn-primary" href="<?php echo site_url('admin/employees/form/'.$new->id); ?>"><i class="fa fa-edit"></i> <?php echo lang('edit')?></a>
					
					
					<a class="btn btn-danger" href="<?php echo site_url('admin/employees/delete/'.$new->id); ?>" onclick="return areyousure(this);"><i class="fa fa-trash"></i> <?php echo lang('delete')?></a>
				</div>
			</td>
		</tr>
<?php $i++; endforeach;?>
