...
<div class="box box-primary">
    ...
    <!-- form start -->
	<?php echo form_open('admin/interview/save_interview_assessment', $attribute= array('id' => 'ContactForm', 'class' => 'ContactForm') ) ?>
    <div class="box-body" id="print-content">
        ...
        <?php if(!empty($login->id)): ?>
            <input type="text" name="login_id" value="<?php echo str_replace(array('+', '/', '='), array('-', '_', '~'), $this->encrypt->encode($login->id)) ?>" >
        <?php endif ?>
    </div>
    <!-- /.box-body -->
