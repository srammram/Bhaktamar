...
<?php echo form_open('admin/interview/save_srrf', $attribute= array('id' => 'ContactForm', 'class' => 'ContactForm') ) ?>
		...
		<section>
            ...
            <div class="form_table">
                <div class="row im">
                    ...
                    <div class="col-sm-10"> <input type="text" name="job_title" value="" ></div>
                </div>
            </div>
            <table>
                <tr class="tie">
                    <td><input type="radio" name="job_time" value="full_time" checked><span class=" ando">Full Time</span></td>
            ...
            <div class="form_table">
                <div class="row im">
                    ...
                    <!-- <div class="col-sm-9"> <input type="text" name="anti_start_date" class="form-control" data-date-format="yyyy/mm/dd"></div> -->
					 <div class="input-group">
                                <input type="text" id="datepicker" name="anti_start_date" data-date-format="yyyy/mm/dd">
            ...
            <table>
                <tr class="tie">
                    <td><input type="radio" name="position" value="1" checked><span class=" ando">New Position</span></td>
