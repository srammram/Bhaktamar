...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/payroll/employee/get_deductionlist',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/payroll/employee/DeductionList') ?>"> <?= lang('Employee_deduction') ?>
            </a></li>
    </ol>
</section>
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    <div class="box">
        <div class="box-header">
            <h2 class="blue"><?= lang('Employee_deduction') ?></h2>
            <div class="box-icon">
                <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                        class="fa fa-fw fa-plus"></i><?= lang('Add_deduction') ?></a>
            </div>
        </div>
                        ...
                        <table id="UnitTable" class="table table-bordered table-hover table-striped reports-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?= lang('Deduction_name') ?></th>
                                    <th><?= lang('deduction_descr') ?></th>
                                    <th><?= lang('Deduction_amount') ?></th>
                                    <th><?= lang('month') ?></th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= lang('Add_deduction') ?></h4>
            </div>
            <div class="modal-body form" style="position: relative;padding: 21px;">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label><?= lang('Deduction_name') ?><span class="required">*</span></label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control allowdecimalpoint" name="deduction_amount">
                        </div>

                        <div class="form-group">
                            <label><?= lang('month') ?></label>
                            <div class="input-group">
                                <input type="text" name="month" id="date" class="form-control monthyear" onkeydown="return false">
...
var table;
var saveRow = 'admin/payroll/employee/add_deduction';
var edit = 'admin/payroll/employee/update_deduction';
var deleteRow = 'admin/payroll/employee/delete_deduction/';
...
function edit_title(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('admin/payroll/employee/edit_deduction/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            ...
            $('[name="deduction_name"]').val(data.Deduction_name);
            $('[name="deduction_amount"]').val(data.deduction_amount);
            $('[name="month"]').val(data.Deduction_month);
