...
<div class="modal-body">
    ...
    <div class="form-group">
		...
		<?php 
		if(isset($terminations))
		{
		
			foreach($terminations as $type)
			{
				?>
				<option value="<?php echo $type->id ; ?>"<?php if(!empty($termination->termination_reason)) echo $termination->termination_reason == $type->id ?'selected':''  ?>
				><?php echo $type->Termination_type ; ?></option>
