...
<div class="box box-primary">
    <div class="box-header with-border bg-primary-dark">
        <h3 class="box-title"><?= lang('view/edit_performance_appraisal') ?> </h3>
    </div>
    <!-- /.box-header -->
                ...
                <div class="table">
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="joined_date" value="<?php echo $employee->joined_date ?>"></td>
				...
				<div class="table_work">
					...
					<table class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="knowledge_score" value="<?php if(!empty($appraisal->knowledge_score)) { echo $appraisal->knowledge_score; }?>" ></td>
							<td><input type="text" name="knowledge_comments" value="<?php if(!empty($appraisal->knowledge_comments)) { echo $appraisal->knowledge_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						 <tr>
                           <td><b class="org"> Ability to Organize: </b><br>
                            ...
                            <td><input type="text" name="ability_score" value="<?php if(!empty($appraisal->ability_score)) { echo $appraisal->ability_score; }?>" ></td>
							<td><input type="text" name="ability_comments" value="<?php if(!empty($appraisal->ability_comments)) { echo $appraisal->ability_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						 <tr>
                           <td><b class="org"> Quality of Work:</b><br>
                            ...
                            <td><input type="text" name="quality" value="<?php if(!empty($appraisal->quality)) { echo $appraisal->quality; }?>" ></td>
							<td><input type="text" name="quality_comments" value="<?php if(!empty($appraisal->quality_comments)) { echo $appraisal->quality_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						<tr>
                           <td><b class="org"> Quantity of Work:</b><br>
                            ...
                            <td><input type="text" name="quantity" value="<?php if(!empty($appraisal->quantity)) { echo $appraisal->quantity; }?>" ></td>
							<td><input type="text" name="quantity_comments" value="<?php if(!empty($appraisal->quantity_comments)) { echo $appraisal->quantity_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						<tr>
                           <td><b class="org"> Communication: </b><br>
                            ...
                            <td><input type="text" name="communication" value="<?php if(!empty($appraisal->communication)) { echo $appraisal->communication; }?>" ></td>
							<td><input type="text" name="communication_comments" value="<?php if(!empty($appraisal->communication_comments)) { echo $appraisal->communication_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						<tr>
                           <td><b class="org"> Teamwork:</b><br>
                            ...
                            <td><input type="text" name="teamwork" value="<?php if(!empty($appraisal->teamwork)) { echo $appraisal->teamwork; }?>" ></td>
							<td><input type="text" name="teamwork_comments" value="<?php if(!empty($appraisal->teamwork_comments)) { echo $appraisal->teamwork_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						<tr>
                           <td><b class="org"> Meet Deadlines:</b><br>
                            ...
                            <td><input type="text" name="meet_deadlines" value="<?php if(!empty($appraisal->meet_deadlines)) { echo $appraisal->meet_deadlines; }?>" ></td>
							<td><input type="text" name="meet_deadlines_comments" value="<?php if(!empty($appraisal->meet_deadlines_comments)) { echo $appraisal->meet_deadlines_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						<tr>
                           <td><b class="org"> Decision Making/Problem Analysis: </b><br>
                            ...
                            <td><input type="text" name="decision" value="<?php if(!empty($appraisal->decision)) { echo $appraisal->decision; }?>" ></td>
							<td><input type="text" name="decision_comments" value="<?php if(!empty($appraisal->decision_comments)) { echo $appraisal->decision_comments; }?>" ></td>
                        </tr>
						<tr></tr>
						<tr>
                           <td><b class="org"> Professionalism:</b><br>
                            ...
                            <td><input type="text" name="professionalism" value="<?php if(!empty($appraisal->professionalism)) { echo $appraisal->professionalism; }?>" ></td>
							<td><input type="text" name="professionalism_comments" value="<?php if(!empty($appraisal->professionalism_comments)) { echo $appraisal->professionalism_comments; }?>" ></td>
                        </tr>
						<tr class="total_sec">
						
                           <td><b class="org"> TOTAL SCORES FOR SECTION 1:</td>
                            <td><input type="text" name="section1_total_score" value="<?php if(!empty($appraisal->section1_total_score)) { echo $appraisal->section1_total_score; }?>" ></td>
							<td><input type="text" name="section1_comments" value="<?php if(!empty($appraisal->section1_comments)) { echo $appraisal->section1_comments; }?>" ></td>
                        </tr>
						<tr class="total_sec">
                           <td><b class="org"> OVERALL SCORES FOR SECTION 1 (TOTAL SECTION 1 DIVIDE BY 9)</td>
                            <td><input type="text" name="section1_overall_score" value="<?php if(!empty($appraisal->section1_overall_score)) { echo $appraisal->section1_overall_score; }?>" ></td>
							<td><input type="text" name="section1_overall_comments" value="<?php if(!empty($appraisal->section1_overall_comments)) { echo $appraisal->section1_overall_comments; }?>" ></td>
                        </tr>
                        <tr></tr>
                ...
                <div class="table">
                    <table class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="mgt" value="<?php if(!empty($appraisal->mgt)) { echo $appraisal->mgt; }?>" ></td>
                            <td><input type="text" name="mgt_cmts" value="<?php if(!empty($appraisal->mgt_cmts)) { echo $appraisal->mgt_cmts; }?>" ></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="info" value="<?php if(!empty($appraisal->info)) { echo $appraisal->info; }?>" ></td>
                            <td><input type="text" name="info_cmts" value="<?php if(!empty($appraisal->info_cmts)) { echo $appraisal->info_cmts; }?>" ></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="resource" value="<?php if(!empty($appraisal->resource)) { echo $appraisal->resource; }?>" ></td>
                            <td><input type="text" name="resource_cmts" value="<?php if(!empty($appraisal->resource_cmts)) { echo $appraisal->resource_cmts; }?>" ></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="motive" value="<?php if(!empty($appraisal->motive)) { echo $appraisal->motive; }?>" ></td>
                            <td><input type="text" name="motive_cmts" value="<?php if(!empty($appraisal->motive_cmts)) { echo $appraisal->motive_cmts; }?>" ></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td><input type="text" name="business_dev" value="<?php if(!empty($appraisal->business_dev)) { echo $appraisal->business_dev; }?>" ></td>
                            <td><input type="text" name="business_dev_cmts" value="<?php if(!empty($appraisal->business_dev_cmts)) { echo $appraisal->business_dev_cmts; }?>" ></td>
                        </tr>
                        <tr class="total_sec">
                            <td>
                                <b class="org">TOTAL SCORES FOR SECTION 2:</b>
                            </td>
                            <td><input type="text" name="section2_total_score" value="<?php if(!empty($appraisal->section2_total_score)) { echo $appraisal->section2_total_score; }?>" ></td>
                            <td><input type="text" name="section2_cmts" value="<?php if(!empty($appraisal->section2_cmts)) { echo $appraisal->section2_cmts; }?>" ></td>
                        </tr>
                        <tr class="total_sec">
                            <td>
                                <b class="org">OVERALL SCORES FOR SECTION 2 (TOTAL SECTION 2 DIVIDE BY 5)</b>
                            </td>
                            <td><input type="text" name="section2_overall_score" value="<?php if(!empty($appraisal->section2_overall_score)) { echo $appraisal->section2_overall_score; }?>" ></td>
                            <td><input type="text" name="section2_overall_comments" value="<?php if(!empty($appraisal->section2_overall_comments)) { echo $appraisal->section2_overall_comments; }?>" ></td>
                        </tr>
                       <tr class="total_sec">
                            <td>
                                <b class="org">OVERALL SCORES FOR THIS REVIEW PERIOD (Overall scores divided by # of sections evaluated):</b>
                            </td>
                            <td><input type="text" name="section2_overall_review_score" value="<?php if(!empty($appraisal->section2_overall_review_score)) { echo $appraisal->section2_overall_review_score; }?>" ></td>
                            <td><input type="text" name="section2_overall_review_comments" value="<?php if(!empty($appraisal->section2_overall_review_comments)) { echo $appraisal->section2_overall_review_comments; }?>" ></td>
                        </tr>
                    </table>
                </div>
            </div>
                ...
                <div class="table">
                    <table class="table-responsive">
                        <tr>
                            ...
                            <td><input type="text" name="accomplish" value="<?php if(!empty($appraisal->accomplish)) { echo $appraisal->accomplish; }?>" ></td>
                        </tr>
                        <tr>
                    ...
                    <textarea name="eval_cmts" class="areas col-md-12 col-lg-12 col-sm-12"><?php if(!empty($appraisal->eval_cmts)) { echo $appraisal->eval_cmts; }?></textarea>
                    <table class="table-responsive">
                        <tr>
                        </tr>
                        <tr>
                    ...
                    <textarea name="emp_cmts" class="areas col-md-12 col-lg-12 col-sm-12"><?php if(!empty($appraisal->emp_cmts)) { echo $appraisal->emp_cmts; }?></textarea>
                    <table class="table-responsive">
                        <tr>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><input type="text" name="goal1" value="<?php if(!empty($appraisal->goal1)) { echo $appraisal->goal1; }?>" ></td>
                            <td><input type="text" name="priority_a" value="<?php if(!empty($appraisal->priority_a)) { echo $appraisal->priority_a; }?>" ></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
                            <td><input type="text" name="goal2" value="<?php if(!empty($appraisal->goal2)) { echo $appraisal->goal2; }?>" ></td>
                            <td><input type="text" name="priority_b" value="<?php if(!empty($appraisal->priority_b)) { echo $appraisal->priority_b; }?>" ></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
                            <td><input type="text" name="goal3" value="<?php if(!empty($appraisal->goal3)) { echo $appraisal->goal3; }?>" ></td>
                            <td><input type="text" name="priority_c" value="<?php if(!empty($appraisal->priority_c)) { echo $appraisal->priority_c; }?>" ></td>
                        </tr>
                    </table>
                </div>
            </div>
