...
<div class="box box-primary">
    ...
    <?php echo form_open('admin/employee/save_commencement', $attribute= array('id' => 'Commencement', 'class' => 'ContactForm') ) ?>
    <div class="box-body">
    ...
    <div class="box-footer">
        ...
        <button id="saveContact" type="submit" class="btn bg-olive btn-flat saveCommencement" style="display:none ;"><?= lang('save') ?></button>&nbsp;&nbsp;&nbsp;
...
<script>
    $("#Commencement :input").attr("disabled", true);
    var contactForm = $("#Commencement");
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a  data-target="#modalSmall" title="View" data-placement="top" data-toggle="modal"
                    href="<?php echo base_url()?>admin/payroll/employee/add_new_job/<?= $employee->id ?>" class="btn bg-navy btn-md btn-flat">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($item->status == 0){ ?>
                                        <!--<a href="<?php echo site_url('admin/employee/job_activate/'.$item->id)?>" type="button" class="btn btn-default btn-xs"><?= lang('job_expired') ?></a>-->
										 <a href="#" type="button" class="btn btn-default btn-xs"><?= lang('job_expired') ?></a>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-xs btn-danger"
                                           onClick="return confirm('Are you sure you want to delete?')" href="<?php echo site_url('admin/employee/delete_job/'. $item->id) ?>" onclick="deleteItem('1')"><i class="glyphicon glyphicon-trash"></i></a>
                                    </div>
                                </td>
...
<!-- /.box -->
<script>
$(".saveCommencement").click(function ()  {

    $("#Commencement").validate({
        excluded: ':disabled',
        rules: {
			...
			date_of_permanency: { DateValidateGreaterthan: "#datepicker3" },
			probation_end_date: { DateValidateGreaterthan: "#datepicker3" },
        },
