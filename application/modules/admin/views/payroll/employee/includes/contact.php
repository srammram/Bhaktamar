...
<div class="box box-primary">
    ...
    <?php echo form_open('admin/payroll/employee/save_employeeContact', $attribute= array('id' => 'ContactForm', 'class' => 'ContactForm') ) ?>
    <div class="box-body">
        <?php
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <a  data-target="#modalSmall" title="View" data-placement="top" data-toggle="modal"
                    href="<?php echo base_url()?>admin/employee/add_emergency_contact/<?= $employee->id ?>" class="btn bg-navy btn-md btn-flat">
