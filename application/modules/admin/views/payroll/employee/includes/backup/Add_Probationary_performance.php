...
<div class="box box-primary">
    <div class="box-header with-border bg-primary-dark">
        <h3 class="box-title"><?= lang('add_probationary_performance') ?></h3>
    </div>
    <!-- /.box-header -->
    <!-- form start -->
            ...
            <div class="table_content">
                <div class="table">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Name</td>
                            <td><input type="text" name="reviewer_name"></td>
                            <td>Position</td>
                            <td><input type="text" name="reviewer_position"></td>
                        </tr>
                    </table>
                    <table>
                        <h4 class="det">Review Period:</h4>
                        <tr>
                            <td><input type="radio" name="period" value="3" checked><span class="badge ando">3 months </span></td>
                            <td><input type="radio" name="period" value="6"><span class="badge ando">6 months </span></td>
                            <td><input type="radio" name="period" value="9"><span class="badge ando">9 months </span></td>
                        </tr>
                    </table>
                    <table>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="dependability" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="dependability" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="dependability" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="dependability" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="dependability_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="communication" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="communication" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="communication" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="communication" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="comm_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="job_knowledge" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="job_knowledge" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="job_knowledge" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="job_knowledge" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="job_knowledge_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="problem_solving" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="problem_solving" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="problem_solving" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="problem_solving" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="problem_solving_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="productivity" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="productivity" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="productivity" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="productivity" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="productivity_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                            <td><b>Quality:</b></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="quality" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="quality" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="quality" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="quality" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="quality_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                            <td><b>Teamwork:</b></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="teamwork" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="teamwork" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="teamwork" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="teamwork" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="teamwork_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="planning" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="planning" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="planning" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="planning" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="planning_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul class="meet">
                                    <li><input type="radio" name="performance" value="1" checked><span class=" ando">Excellent </span></li>
                                    <li><input type="radio" name="performance" value="2"><span class=" ando">Good </span></li>
                                    <li><input type="radio" name="performance" value="3"><span class=" ando">Satisfactory </span></li>
                                    <li><input type="radio" name="performance" value="4"><span class=" ando">Unsatisfactory </span></li>
                                </ul>
                            </td>
                        </tr>
                    </table>
                    ...
                    <textarea name="performance_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                    <table>
                    ...
                    <textarea name="employee_comments" class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
					...
					<tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="issue[]" id="issue"></td>
                            <td><input type="text" name="action[]" id="action"></td>
                            <td><input type="text" name="responsibility[]" id="responsibility"></td>
                    ...
                    <textarea name="success_indicators"  class="areas col-md-12 col-lg-12 col-sm-12"></textarea>
                </div> 
				<!--
