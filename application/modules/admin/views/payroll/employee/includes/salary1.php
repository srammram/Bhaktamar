...
<form id="SalaryForm" action="<?php echo site_url('admin/employee/save_salary1')?>" method="post" onsubmit="return get_Cookie('csrf_cookie_name')">
...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <br/>
		<div class="col-md-12">
       <h4><?= lang('salary_all_earnings') ?></h4><div class="col-md-4"></div><div class="col-md-4"><h6 style="margin-bottom:8px;"><?= lang('Official_salary') ?></h6></div>
		</div>
        <hr/>
        <div class="row">
            <div class="col-md-12">
                <?php if(count($salaryEarningList)): foreach($salaryEarningList as $earning):?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4"> 
                            <div class="form-group">
                                <input type="text" name="<?php echo $earning->id ?>" class="form-control key docal earning" id="<?php echo 'earn'.$earning->id ?>"
                            ...
                            <input type="hidden" name="earn[]" value="<?php echo $earning->id ?>">
                                ...
                                <input type="hidden" name="<?php echo $earning->id ?>s" class="form-control currentsalary earning" id="<?php echo 'currentearns'.$earning->id ?>"
                        ...
                        <div class="col-sm-4">
						 ...
						 <div class="col-sm-4">
                            <div class="form-group" >
                                    ...
                                    <input type="hidden"  name="<?php echo $deduction->id ?>s" class="form-control currentsalary deduction" id="<?php echo 'currentearns'.$deduction->id ?>"
                                           value="<?php if(!empty($salarys)){ echo $salarys ;} ?>">
                            </div>
