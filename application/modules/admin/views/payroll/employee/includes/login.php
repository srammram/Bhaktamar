...
<?php
    if(!empty($login)) {
        echo form_open('admin/payroll/employee/reset_password');
    }else{
        echo form_open('admin/payroll/employee/create_user');
    }
?>
<div class="box box-primary">
    ...
    <div class="box-body">
            ...
            <div class="col-md-8">
                ...
                <div class="form-group">
                    ...
                    <label class="css-input switch switch-sm switch-success">
                        <input id="<?php echo $login->id ?>" <?php echo $login->login_active == 1 ? 'checked':'' ?> type="checkbox" onclick='employeeActivation(this)'><span></span>
                    </label>
                </div>
                <?php endif ?>
        ...
        <?php if(!empty($login->id)): ?>
            <input type="hidden" name="login_id" value="<?php echo $employee->employee_id ?>" >
        <?php endif ?>
    </div>
    <!-- /.box-body -->
