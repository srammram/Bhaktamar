                ...
                <div class="wrap-fpanel">
                    <div class="box box-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('admin/reports/employeeList', array('class' => 'form-horizontal','id' => 'Reports')) ?>
                            ...
                            <table class="table table-striped table-bordered "  id="employeelist"cellspacing="0" width="100%">
...
$(document).ready(function() {
    ...
    $('#employeelist').DataTable( {
        ...
        buttons: [
            {
                extend: 'excelHtml5',
                title: 'Employeelist' + currentDate
            },
            {
                extend: 'pdfHtml5',
                title: 'Employeelist' + currentDate
