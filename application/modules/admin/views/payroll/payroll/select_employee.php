...
<div class="row">
 ...
 <?php if(!empty($monthsalary)){      ?>
  <?php echo form_open('admin/payroll/savecurrentsalary', array('class' => 'form-horizontal')) ?>
					...
					<tr class="custom-tr">
						<td class="vertical-td"><?php  echo date('F Y',strtotime($item['salarymont']));  ?><input type="hidden" value="<?php  echo date('Y-m',strtotime($item['salarymont']));  ?>" name="salarymonth[]"></td>
						...
						<td class="vertical-td"><?php echo $item['OvertimeAmount'] ?><input type="hidden" value="<?php echo $item['OvertimeAmount'] ?>" name="Overtimamount[]"></td>
