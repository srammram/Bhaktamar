                ...
                <div class="wrap-fpanel" style="padding:32px;">
                    <div class="box box-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                                <?php echo form_open('admin/payroll/payroll/listSalaryPayment', array('class' => 'form-horizontal')) ?>
                            ...
                            <table id="datatable" class="table table-striped table-bordered datatable-buttons">
                                ...
                                <?php foreach ($payroll_list as $item) : ?>
                                    <tr class="custom-tr">
                                        ...
                                        <td class="vertical-td"><?php echo $item->gross_salary ?></td>
                                        <td class="vertical-td"><?php echo $item->Payment_amount ?></td>
                                        <td class="vertical-td"><?php echo date("F, Y", strtotime($item->month));  ?></td>
                                        <td class="vertical-td">
                                            <div class="btn-group">
                                                <a href="<?php echo base_url().'admin/payroll/payroll/employeePaySlip/'. $item->id ?>" class="btn btn-xs btn-default"  target="_blank" ><i class="fa fa-search" aria-hidden="true"></i></a>
												<a  target="_blank" class="fa fa-pencil-square-o" style="margin-left:12px;"  href=" <?php echo base_url().'admin/payroll/payroll/setSalaryEdit/'.$item->employee_id.'/'.$item->department.'/'.date("Y-m", strtotime($item->month)) ?>  ">
											</a>
                                            </div>
                                        </td>
