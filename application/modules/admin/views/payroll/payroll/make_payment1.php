            ...
            <div class="col-sm-12" data-offset="0">
                <div class="wrap-fpanel">
                    <div class="box box-primary" data-collapsed="0">
                      ...
                      <?php echo form_open('admin/payroll/Official_savePayroll', array('class' => 'form-horizontal')) ?>
                                ...
                                <div class="form-group margin">
										...
										<div class="col-sm-2">
										 <label for="name" class="control-label"><?= lang('Annual_salary') ?></label>
                                            <input type="text" value="<?php if(!empty($payroll->Annual_salary)){ echo $payroll->Annual_salary; }else{  if(isset($taxs['YearSalary'])){echo $taxs['YearSalary']; }else { echo 0; } } ?>" class="form-control tax_cal rates" id="annualsalary" name="annualsalary"   >
								 ...
								 if(isset( $taxs['YearSalary'])&&(isset($taxs['tax']->Tax_percentage)&&(($taxs['tax']->Tax_percentage))>0)){echo round(((( $taxs['YearSalary']/($taxs['tax']->Tax_percentage))-$taxs['tax']->Allow_Benefits)/12),2);  }else { echo 0; } 
                                    ...
                                    <div class="form-group margin">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            ?> " class="form-control rate" id="payment_amount" name="PayAmounts"   readonly>
                                        </div>
                                    </div>
                                <div class="form-group margin">
...
<script type="text/javascript">
       ...
       ///no trigger in payment method on change
