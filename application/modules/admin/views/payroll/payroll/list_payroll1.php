                                    ...
                                    <tr class="custom-tr">
                                        ...
                                        <td class="vertical-td">
                                            <div class="btn-group">
												...
												<a class="fa fa-pencil-square-o" style="margin-left:12px;"  href=" <?php echo base_url().'admin/payroll/setOfficialSalaryEdit/'. str_replace(array('+', '/', '='), array('-', '_', '~'), $this->encrypt->encode($item->employee_id)).'/'.str_replace(array('+', '/', '='), array('-', '_', '~'), $this->encrypt->encode($item->department)).'/'.str_replace(array('+', '/', '='), array('-', '_', '~'), $this->encrypt->encode(date("Y-m", strtotime($item->month)))) ?>  ">
											</a>
                                            </div>
                                        </td>
