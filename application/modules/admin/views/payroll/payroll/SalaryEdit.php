                ...
                <div class="wrap-fpanel">
                    <div class="box box-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                            <?php echo form_open('admin/payroll/payroll/savePayroll', array('class' => 'form-horizontal')) ?>
                            <div class="panel_controls">
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-1 control-label"
                                        style="text-align: right"><?= lang('currency') ?> </label>
                                    <div class="col-sm-3" style="padding-top: 5px">
                                        <select class="form-control select2 currency" name="Currency">
                                            ...
                                            <option value="<?php echo $item->id;  ?>"
                                                <?php  echo get_option('default_currency')== $item->Currency_code ?'selected':''?>>
                                                <?php echo $item->Currency_code;  ?> - <?php echo $item->Country;  ?>
                                            </option>
                                            <?php
													  }
												  }
                                        ...
                                        <input type="hidden" id="Exchangerate"
                                            value="<?php echo get_option('Exchanage_rates'); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label class="col-sm-1 control-label" style="text-align: right"><?= lang('LOP') ?>
                                    </label>
                                    <div class="col-sm-2" style="padding-top: 5px">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2" style="padding-top: 5px">
                                        <input type="text" value=" <?php echo ($salary->Current_total_deduction) ?>"
                                            class="form-control rates" disabled>
                                        <input type="hidden" value=" <?php echo ($salary->Current_total_deduction) ?>"
                                            class="rate" disabled>
                                    </div>
                                    <label class="col-sm-1 control-label"
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" value=" <?php echo $salary->Current_total_payable ?>"
                                            class="form-control rates" disabled>
                                        <input type="hidden" value=" <?php echo $salary->Current_total_payable ?>"
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text"
                                            value=" <?php echo $this->localization->currencyFormat($totalAward) ?>"
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text"
                                            value=" <?php  echo $this->localization->currencyFormat($totalfindeduction)  ?>"
                                            class="form-control rates" name="fine_deduction" id="fine_deduction">
                                        <input type="hidden"
                                            value="<?php  echo $this->localization->currencyFormat($totalfindeduction)  ?>"
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text"
                                            value="<?php if(!empty($payroll)) echo $this->localization->currencyFormat($payroll->bonus) ?>"
                                    ...
                                    <div class="col-sm-2" style="padding-top: 5px">
                                        ...
                                        <input type="hidden"
                                            value="<?php if(isset($payroll->Advance_Amount)){ echo $payroll->Advance_Amount; }else{ echo $Advance ; } ?>"
                                            class="rate">
                                    </div>
                                </div>
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input style="background-color:#fff;border:1px solid #fff;" type="text"
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control tax_cal" id="tax_perc" name="tax_percentage" readonly>
                                    </div>
                                    <div class="col-sm-2">
                                        ...
                                        <input type="text"
                                            ...
                                            class="form-control tax_cal rates" id="annualsalary" name="annualsalary">
                                        <input type="hidden"
                                            value="<?php   if(isset($taxs['YearSalary'])){echo $taxs['YearSalary']; }else { echo 0; }  ?>"
                                    ...
                                    <div class="col-sm-2">
										...
										if(isset( $taxs['YearSalary'])&&(isset($taxs['tax']->Tax_percentage)&&(($taxs['tax']->Tax_percentage))>0)){echo(( ($taxs['YearSalary'])/100)*($taxs['tax']->Tax_percentage))-$taxs['tax']->Allow_Benefits;  }else { echo 0; }  ?>"
                                            class="form-control rates" id="Annualtax" name="Annualtax" readonly>
                                        <input type="hidden"
                                            value="<?php
										if(isset( $taxs['YearSalary'])&&(isset($taxs['tax']->Tax_percentage)&&(($taxs['tax']->Tax_percentage))>0)){echo(( ($taxs['YearSalary'])/100)*($taxs['tax']->Tax_percentage))-$taxs['tax']->Allow_Benefits;  }else { echo 0; } ?>"
                                            class="rate" readonly>
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" value="<?php if(!empty($payroll)){ echo round(($payroll->net_payment),2) ;
											} else{ echo 0;  } 
											?> " class="form-control rates   payment_amount" name="PayAmounts" style="float:left;" readonly>
                                        <input type="hidden" value="<?php if(!empty($payroll)){ echo round(($payroll->net_payment),2) ;
											} else{ echo 0;  } 
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <select class="form-control select2 paymethod" name="payment_method"
                                            id="paymethod">
                                ...
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" value="<?php if(!empty($payroll)) echo $payroll->note ?>"
