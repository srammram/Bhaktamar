                ...
                <div class="wrap-fpanel">
                    <div class="box box-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                                <?php echo form_open('admin/payroll/saveOfficialPayroll', array('class' => 'form-horizontal')) ?>
                                <div class="panel_controls">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2" style="padding-top: 5px">
                                            <input type="text" value=" <?php echo ($salary->total_payable + $salary->total_deduction) ?>" class="form-control rates" disabled>
											 <input type="hidden" value=" <?php echo ($salary->total_payable + $salary->total_deduction) ?>" class="rate" >
                                        </div>
                                        <label class="col-sm-1 control-label" style="text-align: right"><?= lang('deduction') ?> </label>
                                        <div class="col-sm-2" style="padding-top: 5px">
                                            <input type="text" value=" <?php echo ($salary->total_deduction) ?>" class="form-control rates" disabled>
											 <input type="hidden" value=" <?php echo ($salary->total_deduction) ?>" class="rate" disabled>
                                        </div>
                                  <label class="col-sm-1 control-label" style="text-align: right"><?= lang('Late_fine') ?> </label>
                                    ...
                                    <div class="form-group margin">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" value=" <?php echo $salary->total_payable ?>" class="form-control rates"  disabled>
											 <input type="hidden" value=" <?php echo $salary->total_payable ?>" class="form-control rate"  disabled>
                                        </div>
...
>                                        <div class="col-sm-2" style="padding-top: 5px">
                                    ...
                                    <?php endforeach; endif ?>
									   <div class="form-group margin">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" value=" <?php echo $this->localization->currencyFormat($totalAward) ?>" class="form-control" disabled>
                                                <span style="font-size: small"><?= $item->award_name ?></span>
                                            </div>
											 <label class="col-sm-1 control-label" style="text-align: right"><?= lang('OverTime') ?> </label
>                                        <div class="col-sm-2" style="padding-top: 5px">
                                            <input type="text" value="<?php if(isset($OverTime)){ echo $OverTime; }else{ echo 0 ; } ?>" class="form-control OverTime rates" name="OverTime">
											<input type="hidden" value="<?php if(isset($OverTime)){ echo $OverTime ; }else{ echo 0 ; } ?>" class="rate" >
                                        </div>
                                        </div>
                                    <?php
                                    if(!empty($totalAward)){
                                    ...
                                    ?>
									  ...
									  <?php if(!empty($findeduction)): $totalfindeduction = 0; foreach($findeduction as $findeductionitem ): ?>
                                    ...
                                    <?php endforeach; endif ?>
									  <div class="form-group margin">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" value=" <?php  echo $this->localization->currencyFormat($totalfindeduction)  ?>" class="form-control rates" name="fine_deduction" id="fine_deduction">
											<input type="hidden" value="<?php  echo $this->localization->currencyFormat($totalfindeduction)  ?>" class="form-control rate" >
                                        </div>
                                    </div>
									        <?php
                                    if(!empty($totalfindeduction)){
                                        $totalPayable =  $salary->total_payable-$totalfindeduction;
                                    }else{
                                        $totalPayable = $salary->total_payable;
                                    }
                                    ?>
                         ...
                         <input type="hidden" value=" <?php echo $salary->total_payable ; ?>" class="rates" id="grosssalary" name="grosssalary">
                                    <div class="form-group margin">
                                     ...
                                     <div class="form-group margin">
										...
										if(isset( $taxs['YearSalary'])&&(isset($taxs['tax']->Tax_percentage)&&(($taxs['tax']->Tax_percentage))>0)){echo(( ($taxs['YearSalary'])/100)*($taxs['tax']->Tax_percentage))-$taxs['tax']->Allow_Benefits;  }else { echo 0; }  ?>" class="form-control rates" id="Annualtax" name="Annualtax"   readonly>
										 <input type="hidden" value="<?php
										if(isset( $taxs['YearSalary'])&&(isset($taxs['tax']->Tax_percentage)&&(($taxs['tax']->Tax_percentage))>0)){echo(( ($taxs['YearSalary'])/100)*($taxs['tax']->Tax_percentage))-$taxs['tax']->Allow_Benefits;  }else { echo 0; } ?>" class="rate"   readonly>
                                          </div>
											  <div class="col-sm-2">
