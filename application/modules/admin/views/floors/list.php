...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
     "aaSorting": [[0,'asc']],
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/floors/get_floors',
...
<section class="content-header">
    <h1>
        <?php echo lang('floors'); ?>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo site_url('admin/dashboard') ?>"><i class="fa fa-dashboard"></i>
                <?php echo lang('dashboard')?></a></li>
        <li class="active"><?php echo lang('floors').' '.lang('list'); ?></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('floors').' '.lang('list'); ?></h2>
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                <li>
                                    <a href="<?php echo base_url('admin/floors/form'); ?>">
                                        <i class="fa fa-plus"></i> <?= lang('floor_add') ?>
                                    </a>
                                </li>
                            </ul>
                        </li>
