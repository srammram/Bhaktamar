...
<script>
     $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
            ...
            'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/fund/get_property_management_fee/',
...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('admin/fund/property_management_fee') ?>"> <?php echo lang('property_management_fee_list')?> </a></li>
          </ol>
</section>
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('property_management_fee_list'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo base_url('admin/fund/property_management_fee_form'); ?>" >
                                <i class="fa fa-plus"></i> <?= lang('add_property_management_fee') ?>
                            </a>
                        </li>
