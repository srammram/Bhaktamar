...
<script>
     $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
          ...
          'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/crm/Crm/get_campaign',
...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('admin/crm/Crm/campaign') ?>"> <?php echo lang('campaign')." ".lang('list') ?> </a></li>
          </ol>
</section>
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    ...
    <div class="box-header">
       <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?php echo  lang('campaign')." ".lang('list'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo base_url('admin/crm/Crm/campaignForm'); ?>" >
                                <i class="fa fa-plus"></i> <?= lang('add_campaign') ?>
                            </a>
                        </li>
                        ...
                        <thead>
                            <tr>
                               ...
                               <th><?php echo lang('id'); ?></th>
								<th><?php echo lang('campaign_name'); ?></th>
