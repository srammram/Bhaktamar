...
<script>
     $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
          ...
          'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/crm/Crm/get_sms_history',
...
<section class="content-header">
          <h1>
			 <?php echo lang('sms_history'); ?>
           </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo site_url('admin/dashboard') ?>"><i class="fa fa-dashboard"></i> <?php echo lang('dashboard')?></a></li>
			<li><a href="<?php echo site_url('admin/crm/Crm/ClientList') ?>"> <?php echo lang('sms_history'); ?> </a></li>
          </ol>
</section>
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
	<div class="box">
    <div class="box-header">
       <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i> <?php echo lang('sms_history'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
