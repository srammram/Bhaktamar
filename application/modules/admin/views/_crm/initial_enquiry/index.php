...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/crm/Crm/get_initial_enquiry',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/payroll/office/department') ?>"> <?= lang('Initial_Enquiry') ?> </a></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('Initial_enquiry_list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_Enquiry') ?></a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= lang('add_Enquiry') ?></h4>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            <label class="control-label col-md-3"><?= lang('contact') ?></label>
                            <div class="col-md-9">
						...
						<div class="form-group">
                            <label class="control-label col-md-3"><?= lang('lead_attend_by') ?></label>
                            <div class="col-md-9">
                                <select class="select2 form-control "   style="width: 100%;" name="attended_by">
...
var table;
var saveRow = 'admin/crm/Crm/add_initial_enquiry';
var edit = 'admin/crm/Crm/update_initial_enquiry';
var deleteRow = 'admin/crm/Crm/delete_initial_enquiry/';
...
function edit_title(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('admin/crm/Crm/edit_initial_enquiry')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
			...
			$('[name="attended_by"]').val(data.attended_by);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Initial Enquiry'); // Set title to Bootstrap modal title
