...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/Building/getBuildings',
...
<div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="icon-layers"></i> Building</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
       ...
       <div class="col-md-12">
        <div class="col-md-3">
            <div class="white-box bg-inverse p-t-10 p-b-10">
                <h3 class="box-title text-white">Total Building</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="totalProjects" class="counter text-white">
					<?php  $building=$this->db->get_where('building_info',array('soft_delete'=>0))->result();
if(!empty($building)){  echo count($building) ;}else{ echo 0; }
?></span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="white-box bg-success p-t-10 p-b-10">
                <h3 class="box-title text-white">Completed Building</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="completedProjects" class="counter text-white">
					<?php  $building=$this->db->get_where('building_info',array('status'=>lang('Completed')))->result();
if(!empty($building)){  echo count($building) ;}else{ echo 0; }
?>
        ...
        <div class="col-md-3">
            <div class="white-box p-t-10 p-b-10 bg-info">
                <h3 class="box-title text-white">In Process Building</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="inProcessProjects" class="counter text-white">
<?php  $building=$this->db->get_where('building_info',array('status'=>lang('Ongoing')))->result();
if(!empty($building)){  echo count($building) ;}else{ echo 0; }
?>
        ...
        <div class="col-md-3">
            <div class="white-box p-t-10 p-b-10 bg-danger">
                <h3 class="box-title text-white">Overdue Building</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="overdueProjects" class="counter text-white">

					<?php  $building=$this->db->get_where('building_info',array('planned_completion_date<'=>'now()','status'=>lang('Ongoing')))->result();
if(!empty($building)){  echo count($building) ;}else{ echo 0; }
?>
					</span></li>
                </ul>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group custom-action">
						<a href="<?php echo base_url('admin/Building/form'); ?>" class="btn btn-outline btn-success btn-sm">Add New Building <i class="fa fa-plus" aria-hidden="true"></i></a>
						<!--<a href="javascript:;" id="createProject" class="btn btn-outline btn-info btn-sm">Add Project Category <i class="fa fa-plus" aria-hidden="true"></i></a>-->
						<a href="#" class="btn btn-outline btn-danger btn-sm"><i class="fa fa-bar-chart" aria-hidden="true"></i> Gantt Chart</a>
					<!--	<a href="#" class="btn btn-outline btn-primary btn-sm">Project Templates <i class="fa fa-plus" aria-hidden="true"></i></a>
						<a href="#" class="btn btn-outline btn-info btn-sm">View Archive <i class="fa fa-trash" aria-hidden="true"></i></a>-->
					</div>
				</div>
			</div>
