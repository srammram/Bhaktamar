...
<script>
     $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
            ...
            'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/Facility/get_services/',
...
<section class="content-header">
          ...
          <ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('admin/vendor/services') ?>"> <?php echo lang('utility_services')?> </a></li>
          </ol>
</section>
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('utility_services').' '.('list'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo base_url('admin/Facility/utility_service_form'); ?>" >
                                <i class="fa fa-plus"></i> <?= lang('add_services') ?>
                            </a>
                        </li>
                    </ul>
                </li>
                        ...
                        <thead>
                            ...
                            <th><?= lang("id"); ?></th>
                                ...
                                <th><?= lang("contact_person"); ?></th>
								 <th><?= lang("services_type"); ?></th>
                                <th><?= lang("services_duration"); ?></th>
