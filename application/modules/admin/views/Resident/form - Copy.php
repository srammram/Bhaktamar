                    ...
                    <form method="post" action="<?php echo site_url('admin/Resident/form/'.$id); ?>"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="building_id" class="form-control" id="building"
                                ...
                                <option><?php echo lang('select')?></option>
                                <?php if(isset($project1)){ foreach($project1 as $item) {		 ?>
                                <option value="<?php  echo $item->id ?>"
                                    <?php  if(isset($project_id)){ echo $project_id == $item->id ?'selected':'' ;  } ?>>
                                    <?php echo $item->Name  ?></option>
                                <?php } }    ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select name="assigned_unit[]" class="form-control  assigned_unit"  onchange="get_unitOwner(this.value)">
                                <?php if(!empty($projectunits)){ foreach($projectunits as $item){
                                     $selected = in_array( $item->uid, $assigned_unit ) ? ' selected="selected" ' : '';     ?>
						...
						<div class="form-group col-md-6">
                            <label for="textarea">Owner Details</label>
                            <input type="text" name="owner_details" 
                                id="owner_details" class="form-control" autocomplete=off""  readonly/>
                            <input type="hidden" name="owner_id" id="ownerid" value="<?php if(isset($email)){ echo $email ; } ?>"
                                autocomplete=off"" />
						</div>
                        <div class="form-group col-md-6">
...
>>>>>>> 06bdfd0a089d2d61a66a87a32d3cf8da4cfbd158
                            <input type="hidden" name="id" value="<?php  if(!empty($residentid)){ echo $residentid ;  } ?>"
                                class="form-control" id="residentid" />
                            <input class="btn btn-primary"    style="float:right;"id="residentsubmit" type="submit" value="Save" />
                        </div>
                    </form>
                </div><!-- /.box -->
            </div>
