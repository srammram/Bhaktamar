...
<style>
	.resident_sec{padding: 0px;}
	.resident_sec .form-inline{margin-bottom: 5px;}
	.resident_sec .form-inline .form-group{margin-bottom: 5px;}
	.resident_sec .form-inline .form-control{width: 100%!important;}
</style>
                ...
                <div class="box-body">
                    <form method="post" action="<?php echo site_url('admin/Resident/form/'.$id); ?>"
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <!--   <select name="Amenities[]" class="form-control my-select assigned_unit" multiple="multiple">-->
