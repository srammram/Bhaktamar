                ...
                <div class="col-sm-12 table-responsive">
                    <table id="ReportDetailsData" class="table table-bordered table-hover table-striped table-condensed reports-table">
                       <thead>
                        ...
                        <tbody><tr><td colspan="6" class="dataTables_empty">No data available in table</td></tr></tbody>                   
                    </table>
    ...
    /*     $('#pdf').click(function (event) {
       ...
       /*  $('#image').click(function (event) {
        ...
        $(document).on('click', '.pagination a',function(e){
            ...
            e.preventDefault();
            $url = '<?php echo  base_url('admin/reports/get_prospective_reports')?>';
            $url_seg = $url.split('/');
        ...
        $('#start_date,#end_date').css('border-color', '#ccc'); 
                  $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $('#ReportDetailsData > tbody').append('<tr><td colspan="6" class="dataTables_empty">No data available in table</td></tr>');    
                            }
                            else{
...
$("#xls").click(function(){
      ...
      $("#ReportDetailsData").table2excel({
        exclude: ".noExl",
        name: "Worksheet Name",
        filename: "ProspectiveEnquiry  " //do not include extension
