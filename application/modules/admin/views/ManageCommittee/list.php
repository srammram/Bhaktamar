...
<script>
     $(document).ready(function () {
        oTable = $('#UnitTable').dataTable({
            ...
            'sAjaxSource': "<?php echo  base_url()  ?>"+'admin/ManageCommittee/get_committee/',
...
<section class="content-header">
         <h1>
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo lang('Management_committee'); ?></li>
          </ol>
</section>
...
<div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
    ...
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('Management_committee').''.lang('list'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo base_url('admin/ManageCommittee/form'); ?>" >
                                <i class="fa fa-plus"></i> <?= lang('add_Management_committee') ?>
                            </a>
                        </li>
                ...
                <div class="table-responsive col-sm-12">
                    <table id="UnitTable" class="table table-bordered table-hover table-striped reports-table">
                        <thead>
                            <tr>
                            <th><?= lang("id"); ?></th>
                               <th><?php echo lang('Committe_name'); ?></th>
			<th><?php echo lang('Committe_StartDate'); ?></th>
			<th><?php echo lang('Committe_Leader'); ?></th>
