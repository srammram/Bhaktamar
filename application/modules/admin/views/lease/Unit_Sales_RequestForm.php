...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/lease/') ?>"> <?php echo lang('unit_sales_request')?> </a></li>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('unit_sales_request'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
             
					 <form method="post" action="<?php echo site_url('admin/lease/unit_sale_request_form/'.$requesttypid.'/'.$unitid.'/'.$id); ?>"
                    ...
                    <!--    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                   <input type="text" name="Suggested_amount" class="form-control allowdecimalpoint" autocomplete='off'
							...
							<div class="col-md-2">
                                ...
                                <div class="col-md-3">
                                     <input type="text" name="Commission" class="form-control allowdecimalpoint" autocomplete='off'
