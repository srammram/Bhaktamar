...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('owner/Myunits/unit_request_form') ?>"> <?php echo lang('unit_request_form')?> </a></li>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" action="<?php echo site_url('owner/Myunits/unit_request_form/'.$requesttypid.'/'.$unitid.'/'.$id); ?>"
