					...
					<table class="homepage table text-center font-bold">
						...
						<tbody>
							<tr>
								<td>ផ្ទះលេខ</td>
								<td>:</td>
								<td><input  style= "height:22px;text-align: left;" type="text"  value="C17"   class="form-control"></td>
							</tr>
							<tr>
								<td>ផ្លូវលេខ</td>
								<td>:</td>
									...
									<table class="table table-bordered first_li_r_r">
										<tbody>
											<tr class="first_li_r">
												...
												<td colspan="2" style="border-right:0px;border-left: 0px;"><input type="text" value="ផ្ទះលេខ C17" class="form-control"></td>
