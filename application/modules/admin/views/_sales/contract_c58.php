					...
					<table class="homepage table text-center font-bold">
						...
						<tbody>
							<tr>
								<td>ផ្ទះលេខ</td>
								<td>:</td>
								<td><input  style= "height:22px;text-align: left;" type="text"  value="C58"   class="form-control"></td>
							</tr>
							<tr>
								<td>ផ្លូវលេខ</td>
								<td>:</td>
							...
							<tr class="f59">
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											<tr>
												<td colspan="7" class="pinkhead text-center"><input type="text" style="text-align: center;background-color: #ffb6c1;height: 17px;padding: 0px;"value="តារាងបង់ប្រាក់រំលស់ រយះពេល 12 ខែ" class="form-control"></td>
											</tr>
											<tr>
