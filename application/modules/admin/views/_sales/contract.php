					...
					<table class="homepage table text-center font-bold">
						...
						<tbody>
							<tr>
								<td>ផ្ទះលេខ</td>
								<td>:</td>
								<td><input  style= "height:22px;"type="text"  value="<?php if(isset($bookingdetails->address)){  echo $bookingdetails->address ;  }  ?>"   class="form-control"></td>
							</tr>
							<tr>
								<td>ផ្លូវលេខ</td>
								<td>:</td>
								<td><input type="text" style= "height:22px;" value="<?php if(isset($bookingdetails->street)){  echo $bookingdetails->street ;  }  ?>"  class="form-control"></td>
							</tr>
							<tr>
								<td>ប្រភេទផ្ទះ</td>
								<td>:</td>
		...
		<!---  sceond page   --->
			<div class="col-sm-12 col-xs-12 brown"  >
				<div class="col-sm-12  col-xs-12 se_f_dff">
					...
					<h5 class="text-left"><input type="text" class="form-control" value='កិច្ចព្រមព្រៀងទិញ-លក់ ផ្ទះ  ហ្សប ហោស៍  (កិច្ចព្រមព្រៀងទិញ-លក់ ផ្ទះ  ហ្សប ហោស៍  (បន្ទាប់ពីនេះហៅកាត់ថា "កិច្ចព្រមព្រៀង"))' style="padding: 0px;"></h5>
				</div>
				...
				<div class="col-sm-12 col-xs-12">
					<table class="table main_ta_l " style="border:black;">
						<tbody>
							...
							<tr class="f59">
								<td colspan="2" style="font-size: 12px;font-family: 'khmer_os_muol_lightregular';">■  កាលបរិចេ្ឆទបញ្ចប់ការដ្ឋានសាងសង់៖<span style="display: inline-block;"><input type="text" class="form-control" value="18ខែ  គិតចាប់ពី  ថ្ងៃទី06  ខែឧសភា  ឆ្នាំ2019" style="text-align: left;font-family: 'khmer_os_muol_lightregular';"></span>   (អាចប្រែប្រួលទៅតាមកាលវិភាគសាងសង់)</td>
							</tr>
							...
							<tr class="f59">
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											<tr>
												<td colspan="7" class="pinkhead text-center">តារាងបង់ប្រាក់កក់30% (6 ដំណាក់កាល)</td>
											</tr>
											<tr>
												<td class="pinkhead" style="width:10%;">ពេលកំណត់</td>
							...
							<tr class="f59">
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											<tr>
												<td colspan="7" class="pinkhead text-center">តារាងបង់ប្រាក់រំលស់ រយះពេល 204 ខែ</td>
											</tr>
											<tr>
												<td class="pinkhead" style="width:10%;">ពេលកំណត់</td>
