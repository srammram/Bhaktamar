							...
							<table class="table table_cont5 table_cont6">
								<tbody>
									<tr>
										...
										<td><span> <?php  if(isset($invoice->id)){ echo  $invoice->id    ; }  ?> </span></td>
									</tr>
									<tr>
										<td><span style="background-color:#FFB6C1;">កាលបរិច្ឆេទ / Date&nbsp;&nbsp;&nbsp;&nbsp;   : </span></td>
										<td><span ><?php  if(isset($invoice->booking_date)){ echo  date('d/m/Y',strtotime($invoice->booking_date))    ; }  ?>  </span></td>
									</tr>
					...
					<tbody>
						<tr>
							...
							<td class="text-center"><strong><span style="font-size:12px;"><?php 
								echo $this->sma->formatMoney($invoice->advance_amt)  ;
							?></span></strong></td>
						</tr>
					</tbody>
				</table>
                <table class="table table-bordered table_cont">
					...
					<tbody>
						<tr >
							...
							<td class="text-center"><strong><?php echo $this->sma->formatMoney($invoice->advance_amt)  ;  ?></strong></td>
						</tr>
					</tbody>
				</table>
