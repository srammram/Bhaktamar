...
<!--					<p class="khmer_os"> ✽ </p>-->
					...
					<table class="homepage table text-center font-bold">
						...
						<tbody>
							<tr>
								<td>ផ្ទះលេខ</td>
								<td>:</td>
								<td><input  style= "height:22px;text-align: left;" type="text"  value="C59"   class="form-control"></td>
							</tr>
							<tr>
								<td>ផ្លូវលេខ</td>
								<td>:</td>
								<td><input type="text" style= "height:22px;text-align: left;" value="ផ្លូវរដ្ឋ "  class="form-control"></td>
							</tr>
							<tr>
								<td>ប្រភេទផ្ទះ</td>
								<td>:</td>
								<td><input type="text"  style= "height:22px;text-align: left;" value="ផ្ទះល្វែងអាជីវកម្ម"   class="form-control"></td>
							</tr>
						</tbody>
					</table>
				</div>
				<div class="col-sm-12  col-xs-12 se_f_df">
					...
					<h5 class="text-center font-bold">   <input type="text"  style="text-align:center;" value="  ថ្ងៃទី / ខែ/ ឆ្នាំ2019"   class="form-control">    </h5>
					<h6 class="text-center font-bold"> <input type="text"  style="text-align:center;" value=" លេខរៀង 00003 "   class="form-control"></h6>
		...
		<!---  sceond page   --->
			<div class="col-sm-12 col-xs-12 brown"  >
				<div class="col-sm-12  col-xs-12 se_f_dff">
					...
					<h5 class="text-left"><input type="text" class="form-control" value='កិច្ចព្រមព្រៀងទិញ-លក់ ផ្ទះល្វែងអាជីវកម្ម  (បន្ទាប់ពីនេះហៅកាត់ថា"កិច្ចព្រមព្រៀង" )' style="padding: 0px;"></h5>
				</div>
				...
				<div class="col-sm-12 col-xs-12">
					<table class="table main_ta_l " style="border:black;">
						<tbody>
									...
									<table class="table table-bordered first_li_r_r">
										<tbody>
											<tr class="first_li_r">
												...
												<td colspan="2" style="border-right:0px;border-left: 0px;"><input type="text" value="ផ្ទះលេខ C59" class="form-control"></td>
												<td style="border-left: 0px;"><input type="text" value="ផ្លូវលេខ ផ្លូវរដ្ឋ" class="form-control"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td style="border-right:0px;"><input type="text" value="4.20 " class="form-control" style="font-family: 'khmer_osregular';"></td>
											...
											<tr>
												...
												<td style="border-right:0px;"><input type="text" value="21.50 " class="form-control" style="font-family: 'khmer_osregular';"></td>
												<td style="border-left: 0px;"><input type="text" value="ម៉ែត្រ" class="form-control" style="font-family: 'khmer_osregular';"></td>
												<td style="border-right:0px;"><input type="text" value="16.00" class="form-control" style="font-family: 'khmer_osregular';"></td>
												<td style="border-left: 0px;"><input type="text" value="ម៉ែត្រ" class="form-control" style="font-family: 'khmer_osregular';"></td>
											</tr>
											<tr>
												<td class="pinkhead" style="font-family: 'khmer_osregular';"> ទំហំសរុប </td>
												<td style="border-right:0px;"><input type="text" value="90.30 " class="form-control" style="font-family: 'khmer_osregular';"></td>
												<td style="border-left: 0px;"><input type="text" value="ម៉ែត្រការ៉េ" class="form-control" style="font-family: 'khmer_osregular';"></td>
												<td style="border-right:0px;"><input type="text" value="67.20" class="form-control" style="font-family: 'khmer_osregular';"></td>
												<td style="border-left: 0px;"><input type="text" value=" ម៉ែត្រការ៉េ " class="form-control" style="font-family: 'khmer_osregular';"></td>
											</tr>
							...
							<tr class="f59">
								<td colspan="2" style="font-size: 12px;font-family: 'khmer_os_muol_lightregular';">■  កាលបរិចេ្ឆទបញ្ចប់ការដ្ឋានសាងសង់៖<span style="display: inline-block;"><input type="text" class="form-control" value="18ខែ  គិតចាប់ពី  ថ្ងៃទី16  ខែឧសភា  ឆ្នាំ2019 " style="text-align: left;font-family: 'khmer_os_muol_lightregular';height: 40px;line-height: 40px;width:320px"></span>   (អាចប្រែប្រួលទៅតាមកាលវិភាគសាងសង់)</td>
							</tr>
									...
									<table class="table table-bordered first_li_r_r">
										<tbody>
											...
											<tr>
												...
												<td><input type="text" value="លោក ជិន តារ៉ា"  class="form-control"></td>
											</tr>
											<tr>
												...
												<td><input type="text" value="011103537"  class="form-control"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td><input type="text" value="085 787 896" class="form-control"></td>
											</tr>
											<tr>
												...
												<td><input type="text" value="ផ្ទះ5អឺ ផ្លូវលំ ភូមិត្រពាំងឈូក សង្កាត់ទឹកថ្លា ខណ្ឌសែនសុខ ភ្នំពេញ  " class="form-control"></td>
											</tr>
										</tbody>
									</table>
								</td>
							...
							<tr class="f59">
								<td colspan="2" style="font-size: 12px; font-family: 'khmer_osregular';">- អ៊ីម៉ែល ៖<span><input type="text" class="form_control" style="display: inline-block;"></span> &nbsp; &nbsp;លេខទូរស័ព្ទនៅកម្ពុជា ៖ 085 787 896</td>
							</tr>
							<tr>
									...
									<table class="table table-bordered first_li_r_r">
										<tbody>
											...
											<tr>
												...
												<td><input type="text"  class="form-control"></td>
												<td><input type="text" value="CHEA BUNKHEANG / NA SOVANNDA"  class="form-control"></td>
											</tr>
							...
							<tr>
								<td colspan="2">
									<p style="font-size: 12px; font-family: 'khmer_osregular';"><span>(១)(ពន្ធលើអាករបន្ថែមត្រូវបានរាប់បញ្ចូល)                   </span><span class="pull-right">ថ្លៃទិញ/តារាងបង់ប្រាក់</span></p>
								</td>
							</tr>
							<tr>
								<td>
									<table class="table table-bordered half_s_e">
										<tbody>
											...
											<tr>
												...
												<td ><input type="text" value="$159,800.00 (ដុល្លា)" class="form-control"></td>
											</tr>
							...
							<tr>
								<td >
									<table class="table table-bordered half_s_e" style="width: auto;">
										<tbody>
											<tr>
												<td><input type="text" style="text-align: center;"value="ទឹកប្រាក់ 100% = $159,800.00" class="form-control"></td>
											</tr>
										</tbody>
									</table>
								</td>
							...
							<tr class="c59">
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											<tr>
												<td colspan="7" class="pinkhead text-center"><input type="text" style="text-align: center;background-color: #ffb6c1;height: 17px;padding: 0px;"value="តារាងបង់ប្រាក់រំលស់ រយះពេល 24 ខែ" class="form-control"></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td ><input type="text" value=" 16.05.2019" class="form-control"></td>
												<td><input type="text" value=" 16.06.2019"  class="form-control"></td>
												<td><input type="text" value=" 16.07.2019"  class="form-control"></td>
												<td><input type="text" value=" 16.08.2019"  class="form-control"></td>
												<td><input type="text" value="16.09.2019"  class="form-control"></td>
												<td><input type="text" value=" 16.10.2019"  class="form-control"></td>
												
											</tr>
											<tr>
												<td class="pinkhead" style="width:10%;">ទឹកប្រាក់ត្រូវបង់</td>
												<td ><input type="text" value="$9,588.00"  class="form-control"></td>
												<td ><input type="text" value=" $6,392.00"  class="form-control"></td>
												<td ><input type="text" value=" $6,392.00"  class="form-control"></td>
												<td ><input type="text" value=" $6,392.00"  class="form-control"></td>
												<td ><input type="text" value=" $6,392.00"  class="form-control"></td>
												<td ><input type="text" value=" $6,392.00"  class="form-control"></td>
								...
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											...
											<tr>
												<td class="pinkhead" style="width:10%;">កាលបរិចេ្ទទ</td>
												<td ><input type="text" value=" 16.11.2019" class="form-control"></td>
												<td><input type="text" value=" 16.12.2019"  class="form-control"></td>
												<td><input type="text" value=" 16.01.2020"  class="form-control"></td>
												<td><input type="text" value=" 16.02.2020"  class="form-control"></td>
												<td><input type="text" value="16.03.2020"  class="form-control"></td>
												<td><input type="text" value=" 16.10.2036"  class="form-control"></td>
								...
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											...
											<tr>
												<td class="pinkhead" style="width:10%;">ពេលកំណត់</td>
												<td ><input type="text" style="text-align: center;"value="លើកទី13" class="form-control"></td>
												<td><input type="text" style="text-align: center;"value="លើកទី14 " class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី15" class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី16" class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី17" class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី18" class="form-control"></td>
								...
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											...
											<tr>
												<td class="pinkhead" style="width:10%;">ពេលកំណត់</td>
												<td ><input type="text" style="text-align: center;"value="លើកទី19" class="form-control"></td>
												<td><input type="text" style="text-align: center;"value="លើកទី20 " class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី21" class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី22" class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកទី23" class="form-control"></td>
												<td><input type="text" style="text-align: center;" value="លើកចុងក្រោយ" class="form-control"></td>
							...
							<tr>
								<td colspan="2" style="font-size: 12px; font-family: 'khmer_osregular';">-  ភាគី <b>"អ្នកទិញ" ជិន តារ៉ា</b>  ចំនួន០១ច្បាប់ <b style="color: red!important;"> ជាភាសាខ្មែរ</b></td>
							</tr>
							<tr>
								<td colspan="2" style="font-size: 12px; font-family: 'khmer_osregular';">- ភាគី <b>"អ្នកលក់"រី ឃាង ហេង (ណា សុវណ្ណដា)</b> ចំនួន០១ច្បាប់ <b style="color: red!important;">ជាភាសាខ្មែរ </b></td>
							</tr>
							<tr>
								<td colspan="2" style="font-size: 12px; font-family: 'khmer_osregular';">-  <b>ធនាគារកាណាឌីយ៉ា</b> ចំនួន០១ច្បាប់ <b style="color: red!important;">ជាភាសាខ្មែរ </b></td>
							</tr>
							<tr>
								<td colspan="2"><br></td>
							</tr>
							...
							<tr>
								<td colspan="2">
								<button type="button" class="btn btn-primary save_btn center-block" onclick="showcontractpopup()">Upload</button>
								</td>
							</tr>
						</tbody>
					</table>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <form method="post" action="<?php echo site_url('admin/sales/Sales/contract_save/'); ?>" enctype="multipart/form-data" >	
