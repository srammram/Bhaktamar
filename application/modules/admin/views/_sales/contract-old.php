...
.view_booking {
	...
	.view_booking .table td input{text-align: center;}
...
.pinkhead{
 ...
 @page 
    {
        margin:5mm 0mm 0mm 0mm;  /* this affects the margin in the printer settings */
    }
	body{margin: 2mm;}
}
</style>
...
<!--					<p class="khmer_os"> ✽ </p>-->
				...
				<div class="col-sm-12  col-xs-12 se_f_df">
					...
					<h6 class="text-center font-bold"><input type="text"  style="text-align:center;" value=" លេខរៀង"   class="form-control"> </h6>
				...
				<div class="col-sm-12 col-xs-12">
					<table class="table main_ta_l " style="border:black;">
						<tbody>
							...
							<tr>
								<td colspan="2" style="font-size: 12px; font-family: 'khmer_osregular';padding-bottom: 10px;">- អ៊ីម៉ែល ៖<span><input type="text" class="form_control" style="display: inline-block;text-align: left;font-family: 'khmer_os_muol_lightregular';height: 30px;line-height: 30px;width: 15%;"></span>ទូរសារ ៖ <span><input type="text" class="form_control" value="" style="display: inline-block;text-align: left;font-family: 'khmer_os_muol_lightregular';height: 30px;line-height: 30px;width: 15%;"></span>លេខទូរស័ព្ទនៅកម្ពុជា ៖<span><input type="text" class="form_control" style="display: inline-block;text-align: left;font-family: 'khmer_os_muol_lightregular';height: 30px;line-height: 30px;    width: 15%;"></span>  លេខទូរស័ព្ទនៅបរទេស ៖<span><input type="text" class="form_control" style="display: inline-block;text-align: left;font-family: 'khmer_os_muol_lightregular';height: 30px;line-height: 30px;    width: 15%;"></span></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2">
									<table class="table table-bordered half_s_e">
										<tbody>
											<tr>
												<td colspan="9" class="pinkhead text-center"><input type="text" style="text-align: center;background-color: #ffb6c1;height: 17px;padding: 0px;"value="តារាងបង់ប្រាក់" class="form-control"></td>
											</tr>
											<tr>
