...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'sAjaxSource': '<?= base_url('products/getProducts'.($warehouse_id ? '/'.$warehouse_id : '').($supplier ? '?supplier='.$supplier->id : '')) ?>',
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {"bSortable": false,"mRender": img_hl}, null, null, null, null,  null, <?php if(!$warehouse_id || !$Settings->racks) { echo '{"bVisible": false},'; } else { echo '{"bSortable": true},'; } ?> {"bSearchable":false,"mRender": formatQuantity}, {"bSortable": false,"bSearchable":false, "mRender": recipe_stock},{"bSortable": false,"bSearchable":false, "mRender": recipe_min_qty}, {"bSearchable":false,"bSortable": false}
            ]
            ...
            {column_number: <?php $col++; echo $col; ?>, filter_default_label: "[<?=lang('alert_quantity');?>]", filter_type: "text", data: []},
			 {column_number: <?php $col++; echo $col; ?>, filter_default_label: "[<?=lang('stock');?>]", filter_type: "text", data: []},
			
        ], "footer");

    });
    function recipe_min_qty(x) {
    var y = x;    
   
    return '<a href="'+<?php  echo base_url()  ?>+'admin/procurment/products/stock_min_qty/'+ y +'" data-toggle="modal" data-target="#myModal">stock min qty<a/>';
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <?php if(!$warehouse_id) { ?>
                        <li>
                            <a href="<?= admin_url('products/update_price') ?>" data-toggle="modal" data-target="#myModal" data-backdrop='static' data-keyboard='false'>
