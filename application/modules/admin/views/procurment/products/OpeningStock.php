...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#STData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('products/getOpeningStock'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {"mRender": fld}, null, null, {"bSortable": false}
            ]
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a href="<?= admin_url('products/OpeningStock_Add') ?>" class="tip" data-placement="top" title="<?= lang("Add_OpeningStock") ?>">
