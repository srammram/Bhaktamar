 ...
 var oTable;
    $(document).ready(function () {
        oTable = $('#StockData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('products/stock_details/'.$id) ?>',
...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?=$product->code.' - '.$product->name?> - <?php echo lang('stock_details'); ?><label style="float:right;margin-right:13px;"> <span>Total Stock : </span><?=@$total_stock?></label></h4>
        </div>
