...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/procurment/products/get_department',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/payroll/office/department') ?>"> <?= lang('department') ?> </a></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('department_list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_department') ?></a>
                </div>
            </div>
...
var table;
var saveRow = 'admin/procurment/products/add_department';
var edit = 'admin/procurment/products/update_department';
var deleteRow = 'admin/procurment/products/delete_department/';
...
function edit_title(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('admin/procurment/products/edit_department/')?>/" + id,
        type: "GET",
        dataType: "JSON",
