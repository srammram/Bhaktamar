...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/procurment/products/get_unit',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/procurment/products/unit') ?>"> <?= lang('units') ?> </a></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('units').' '.('list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_unit') ?></a>
                </div>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
						 ...
						 <div class="form-group">
                            <label class="control-label col-md-3"><?= lang('base_unit') ?></label>
                            <div class="col-md-9">
                                <select class="form-control" name="base_unit" id="type" >
								<option value="">Select base_unit</option>                  
								<?php if($base_unit){ foreach($base_unit as $row){  ?>
...
var table;
var saveRow = 'admin/procurment/products/add_unit';
var edit = 'admin/procurment/products/update_unit';
var deleteRow = 'admin/procurment/products/delete_unit/';
...
function edit_title(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('admin/procurment/products/edit_unit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
