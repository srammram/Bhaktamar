...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" +'admin/procurment/products/get_brand',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/procurment/products/brand') ?>"> <?= lang('brand') ?> </a></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('brand').' '.('list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_brand') ?></a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= lang('add_brand') ?></h4>
            </div>
...
var table;
var saveRow = 'admin/procurment/products/add_brand';
var edit = 'admin/procurment/products/update_brand';
var deleteRow = 'admin/procurment/products/delete_brand/';
...
function edit_title(id) {
    ...
    $.ajax({
       url: "<?php echo site_url('admin/procurment/products/edit_brand/')?>/" + id,
        type: "GET",
        dataType: "JSON",
