...
<script type="text/javascript">
 localStorage.setItem('bill_disc','<?= $inv->bill_disc ?>');
    var default_store = 2;
    localStorage.setItem('pi_items', JSON.stringify(<?= $json_inv_items; ?>));
    <?php if($purchase_invoices->id) {?>
       ...
       /*  if (!localStorage.getItem('invoice_date')) {
        ...
        $(document).on('click', '#addItemManually', function (e) {
            ...
            $.ajax({
                ...
                url: '<?= base_url('admin/procurment/products/addByAjax'); ?>',
...
<div class="box">
    <div class="box-header procurment-header">
        <h2 class=""><?= lang('edit_purchase_invoice'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo form_open_multipart("admin/procurment/purchase_invoices/edit/".$inv->id, $attrib)
                ?>
                <div class="col-lg-12">
                                    ...
                                    <td>
										<div class="input-group">
											...
											<div class="input-group-addon no-print" style="padding: 2px 5px;">
												<a href="<?= base_url('admin/procurment/supplier/add'); ?>" id="add-supplier1" class="external" data-toggle="modal" data-target="#myModal">
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <input type="text" name="shipping_charge" id="feright_chargers_shipping"  class="form-control text-right numberonly" value="<?=$inv->shipping?>">
										<input type="hidden" name="freight" id="freight" value="<?=$inv->shipping?>" readonly class="form-control text-right">
									</td>
								<td>
								  ...
								  <td>
                                    ...
                                    <td>
                                       <input type="text" name="round_off" id="round_off_amt"  class="form-control text-right number_minus"  value="<?=$inv->round_off?>">
										<input type="hidden" name="round_off" id="round_off" readonly value="<?=$inv->round_off?>" class="form-control text-right">
									</td>
									<td>
                                ...
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <div class="input-group-addon" style="display: none;padding-left: 10px; padding-right: 10px;">
                                            <a href="<?= base_url('admin/procurment/products/add') ?>" id="addManually1"><i
                    ...
                    <table class="table custom_tables" style="table-layout:fixed">
                            <tbody>
                                <tr>                                    
                                    ...
                                    <td>
                                        <input  name="logged_by" id="logged_by" value="<?php echo $this->session->userdata('username'); ?>" readonly class="form-control">
                                    </td>
                                     <td>                                  
                                    </td>
                                    <td>                                   
...
$(document).ready(function(e) {
	...
	if(supplierid != ''){
		$.ajax({
			type: 'get',
			url: '<?= base_url('admin/procurment/purchase_invoices/supplier'); ?>',
			dataType: "json",
...
$(document).on('change', '#pi_requestnumber', function(){
	...
	$.ajax({
		type: 'get',
		url: '<?= base_url('admin/procurment/purchase_invoices/purchase_invoices_list'); ?>',
		dataType: "json",
		data: {
...
<script>
	...
	$.get('<?= base_url('admin/welcome/set_data/remove_quls/1'); ?>');
