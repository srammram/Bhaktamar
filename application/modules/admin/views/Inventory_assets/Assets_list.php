...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/Inventory/get_assets',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo lang('Assets'); ?></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('Assets'); ?></h2>
                <div class="box-icon">
                    <ul class="btn-tasks">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                                <li>
                                    <a href="<?php echo base_url('admin/Inventory/Assets_Form'); ?>">
                                        <i class="fa fa-plus"></i> <?= lang('Add_Assets') ?>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="table-responsive col-sm-12">
                            <table id="UnitTable" class="table table-bordered table-hover table-striped reports-table">
                                <thead>
                                    <tr><th>Id</th>
							    <th><?php echo lang('Assets_no'); ?></th>
                                <th><?php echo lang('Assets_name'); ?></th>
                                <th><?php echo lang('Facility_Name'); ?></th>
                                <th><?php echo lang('Assets_category'); ?></th>
                                <th><?php echo lang('Assest_cost'); ?></th>
