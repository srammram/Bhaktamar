         ...
         <div class="row">
		 	<div class="col-md-12">
				<div class="btn-group pull-right">
					<a class="btn btn-success" href="<?php echo site_url('admin/Inventory/form'); ?>"><i class="fa fa-plus"></i> Add </a>
				</div>
			</div>
		 </div>
		  <div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><?php echo lang('Inventory'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php $i=1;foreach ($parkmanager as $new):?>
		<tr>
			...
			<td class="gc_cell_left" ><?php echo  $new->Quantity; ?></td>
			<td class="gc_cell_left" ><?php echo  $new->unit; ?></td>
			<td class="gc_cell_left" ><?php echo  $new->Current_status; ?></td>
