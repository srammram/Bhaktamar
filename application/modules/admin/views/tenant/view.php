            ...
            <div class="col-xs-12">
			  ...
			  <div class="box-body">
                       <div class="form-group col-md-6">
                            ...
                            <?php echo  !empty($tenant->leaseunit_type) && $tenant->leaseunit_type == lang('Owner_unit') ? lang('Owner_unit') : FALSE ; ?>
                                <?php echo !empty($tenant->leaseunit_type) && $tenant->leaseunit_type == lang('Lease_unit') ? lang('Lease_unit') : FALSE ; ?>
                        </div>
						 <div class="form-group col-md-6">
						...
						<div class="form-group col-md-6">
                          ...
                          <?php  if(isset($tenant->type)){ echo $tenant->type == lang('Rent')  ? lang('Rent'):'' ;  } ?>
                                   <?php  if(isset($tenant->type)){ echo $tenant->type == lang('Lease')  ?  lang('Lease'):'' ;  } ?>
