    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <?php echo form_open('admin/login') ?>
			...
			<?php echo form_input(array('name'=>'username', 'class'=>'form-control','placeholder'=>'Username','autocomplete="off"')); ?>
	  
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
          	 <?php echo form_password(array('name'=>'password', 'class'=>'form-control','placeholder'=>'Password' ,'autocomplete="off"')); ?>
          	 ...
          	 <?php 
					if(isset($roles)){
						foreach($roles as $role){
							?>
							<option  style="color:black"value="<?php echo $role->Id;  ?>"><?php echo $role->Role_name;  ?></option>   
							<?php
						}
					}
			 ?>
