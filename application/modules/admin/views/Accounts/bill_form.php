        ...
        <div class="col-xs-12">
              <div class="box box-primary" data-collapsed="0">
                        <div class="box-header with-border bg-primary-dark">
                            <h4 style="font-weight:bold;margin-left:12px;"><?= lang('bill') ?></h4>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <div class="col-md-6">
                                    ...
                                    <br>
                                    <select id="boot-multiselect-demo" class="form-control"
                                        name="services">
										<option value=""><?  lang('select')   ?></option>
                                        <?php  if(!empty($services_list)){ foreach($services_list as $item){  ?> 
                                        <option value="<?php  echo $item->id ?>"<?php  if(isset($services_id)){ echo $services_id == $item->id ?'selected':'' ;  } ?> >
