...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/accounts/get_expense_categories',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/accounts/expense_categories') ?>"> <?= lang('expense_categories') ?> </a></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('expense_categories_list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_expense_categories') ?></a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= lang('add_expense_categories') ?></h4>
            </div>
...
var table;
var saveRow = 'admin/accounts/add_expense_category';
var edit = 'admin/accounts/update_expenses_categories';
...
function edit_title(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('admin/accounts/edit_expense_catgory/')?>/" + id,
        type: "GET",
        dataType: "JSON",
