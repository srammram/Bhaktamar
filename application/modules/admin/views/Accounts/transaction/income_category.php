...
$(document).ready(function() {
    oTable = $('#UnitTable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo  base_url()  ?>" + 'admin/accounts/get_income_categories',
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('admin/accounts/income_categories') ?>"> <?= lang('income_categories') ?> </a></li>
    </ol>
</section>
    ...
    <div class="col-sm-12 col-xs-12" style="margin-top: 15px;">
        <div class="box">
            <div class="box-header">
                <h2 class="blue"><?= lang('income_categories_list') ?></h2>
                <div class="box-icon">
                    <a style="margin:4px;" class="btn btn-default btn-sm btn-flat" onclick="add()"><i
                     class="fa fa-fw fa-plus"></i><?= lang('add_income_categories') ?></a>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?= lang('add_income_categories') ?></h4>
            </div>
...
var table;
var saveRow = 'admin/accounts/add_income_category';
var edit = 'admin/accounts/update_income_categories';
var deleteRow = 'admin/accounts/delete_category/';
...
function edit_title(id) {
    ...
    $.ajax({
        url: "<?php echo site_url('admin/accounts/edit_income_catgory/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            ...
            $('.modal-title').text('Edit Income Category'); // Set title to Bootstrap modal title
