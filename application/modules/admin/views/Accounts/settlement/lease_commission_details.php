...
<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Lease Commission Details</li>
          </ol>
</section>
<section class="content">
			  	...
			  	<div class="box-body">
				 	<div class="box-content">
							<div class="col-lg-12 well well-sm">
								<legend style="font-weight:bold;">Lease Commission Details</legend>
								<table class="table">
									<tbody>
										<tr>
											<td>
							...
							<div class="col-lg-12 well well-sm">
								...
								<br>
									<table id="UnitTable" class="table table-bordered table-hover table-striped reports-table">
										...
										<!--<a href="#">Receipt</a>|--> <a href="<?php echo site_url('admin/accounts/commissionpaymentdelete/'.$row->id); ?>">Delete</a></td>
											</tr>
										<?php   $i++; }   }   ?>
		  ...
		  <form  data-toggle="validator" role="form" action="<?php echo site_url('admin/accounts/add_commissionPayment/'.$commission_details->id); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="bv-form">
