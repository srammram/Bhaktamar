...
$(document).ready(function() {
    oTable = $('.requestlisttable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo base_url() ?>" + 'admin/accounts/get_lease_collection',
...
<div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="icon-layers"></i>Lease Collection </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Lease Collection </li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
        ...
        <div class="col-md-3">
            <div class="white-box bg-inverse p-t-10 p-b-10">
                ...
                <ul class="list-inline two-part">
					...
					<?php $lease = $this->db->get_where('tenant_agreement', array('soft_deleted' => 0))->result(); if (!empty($lease)) {echo count($lease);} else {echo 0;} ?></span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="white-box bg-success p-t-10 p-b-10">
                ...
                <ul class="list-inline two-part">
					...
					<?php $lease = $this->db->get_where('tenant_agreement', array('active' => 1))->result();if (!empty($lease)) {echo count($lease);} else {echo 0;} ?>
					</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="white-box p-t-10 p-b-10 bg-info">
                ...
                <ul class="list-inline two-part">
                    ...
                    <li class="tex"><span id="inProcessProjects" class="counter text-white"><?php  
                             $this->db->select("sum(amount) -sum(balanceamount) amount");     
            ...
            <div class="white-box p-t-10 p-b-10 bg-danger">
                ...
                <ul class="list-inline two-part">
                    ...
                    <li class="text"><span id="overdueProjects" class="counter text-white"><?php  
                             $this->db->select("sum(balanceamount) amount");     
							 $this->db->where("soft_deleted","0");
							 $query=$this->db->get("tenant_agreement");
							 if($query->num_rows()>0){
								 $amount=$query->row();
