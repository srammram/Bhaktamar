...
<section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Agreements Details</li>
          </ol>
</section>
<section class="content">
			  	...
			  	<div class="box-body">
				 	<div class="box-content">
							<div class="col-lg-12 well well-sm">
								<legend style="font-weight:bold;">Agreements Details</legend>
								<table class="table">
									<tbody>
										<tr>
											<td>
												<table class="table">
													...
													<tr>
															<td>Tenant Name</td>
															<td>:</td>
															<td> <?php  if(isset($leasedetails->tenant)){ echo $leasedetails->tenant ;  } ?></td>
														</tr>
														<tr>
															<td>Project Name</td>
															<td>:</td>
															<td> <?php  if(isset($leasedetails->project)){ echo $leasedetails->project ;  } ?></td>
														</tr>
														<tr>
															<td>Floor</td>
															<td>:</td>
															<td> <?php  if(isset($leasedetails->floors)){ echo $leasedetails->floors ;  } ?></td>
                                             
														</tr>
														<tr>
															<td>Start Date</td>
															<td>:</td>
															<td> <?php  if(isset($leasedetails->start_date)){ echo $leasedetails->start_date ;  } ?></td>
                                             
														</tr>
														<tr>
															<td>Lease Amount</td>
															<td>:</td>
															<td style=""> <?php  if(isset($leasedetails->amount)){ echo $this->sma->formatMoney( $leasedetails->amount) ;  } ?></td>     
											...
											<td>
												<table class="table">
													...
													<tr>
															<td> Type</td>
															<td>:</td>
															<td>	 <?php  if(isset($leasedetails->type)){ echo $leasedetails->type ;  } ?></td>
														</tr>
														<tr>
															<td> Building</td>
															<td>:</td>
															<td>	 <?php  if(isset($leasedetails->building)){ echo $leasedetails->building ;  } ?></td>
														</tr>
														<tr>
															<td>Unit</td>
															<td>:</td>
														<td> <?php  if(isset($leasedetails->unit)){ echo $leasedetails->unit ;  } ?></td>
														</tr>
														<tr>
															<td>End Date</td>
															<td>:</td>
														<td> <?php  if(isset($leasedetails->end_date)){ echo $leasedetails->end_date ;  } ?></td>
														</tr>
														<tr>
															<td>Balance</td>
															<td>:</td>
															<td> <?php  if(isset($leasedetails->balanceamount)){ echo $this->sma->formatMoney( $leasedetails->balanceamount );  } ?></td>
								...
								<button style="float:right;"type="button" class=" btn btn-danger">Close Agreements</button>
								<button style="float:right;margin-right:12px;"type="button" class="btn btn-success">ReNew</button>
							</div>
							<div class="col-lg-12 well well-sm">
								...
								<br>
									<table id="UnitTable" class="table table-bordered table-hover table-striped reports-table">
										...
										<!--<a href="#">Receipt</a>|--> <a href="<?php echo site_url('admin/accounts/paymentdelete/'.$row->id); ?>">Delete</a></td>
											</tr>
										<?php   $i++; }   }   ?>
		  ...
		  <form  data-toggle="validator" role="form" action="<?php echo site_url('admin/accounts/add_payment/'.$leasedetails->agreement_id); ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8" class="bv-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text"  value="<?php  if(isset($leasedetails->balanceamount)){ echo $leasedetails->balanceamount ;  } ?>" class="form-control tip"  NAME="balanceamount" readonly>
                            </div>
                        </div>
