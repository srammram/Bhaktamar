...
$(document).ready(function() {
    oTable = $('.requestlisttable').dataTable({
        ...
        'bProcessing': true,
        'bServerSide': true,
        'sAjaxSource': "<?php echo base_url() ?>" + 'admin/accounts/get_resale_commission',
...
<div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="icon-layers"></i>Resale  Commission </h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li class="active">Resale Commission </li>
            </ol>
        </div>
        <!-- /.breadcrumb -->
    </div>
       ...
       <div class="col-md-12">
        <div class="col-md-3">
            <div class="white-box bg-inverse p-t-10 p-b-10">
                <h3 class="box-title text-white">Total Resales</h3>
                <ul class="list-inline two-part">
                    <li><i class="fa fa-shopping-bag text-white"></i></li>
                    <li class="text-right"><span id="totalProjects" class="counter text-white">
					<?php $lease = $this->db->get_where('resale_commission', array('soft_deleted' => 0))->result(); if (!empty($lease)) {echo count($lease);} else {echo 0;} ?></span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="white-box bg-success p-t-10 p-b-10">
                ...
                <ul class="list-inline two-part">
					...
					<?php $lease = $this->db->get_where('resale_commission', array('active' => 1))->result();if (!empty($lease)) {echo count($lease);} else {echo 0;} ?>
					</span></li>
                </ul>
            </div>
        </div>
