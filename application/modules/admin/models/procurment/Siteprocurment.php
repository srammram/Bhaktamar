...
//        return FALSE;
	    ...
	    $this->db->select('products.*,categories.name as category_name,price_master.price,price_master.batch_no,price_master.id as batch_id,tax_rates.rate as tax,pro_stock_master.stock_in as available_qty,pro_stock_master.expiry_date');
	    $this->db->from('products');
	    $this->db->join('warehouses_products FWP', 'FWP.product_id=products.id and warehouse_id='.$this->store_id);
	    $this->db->join('categories','categories.id=products.category_id');
	    $this->db->join('pro_stock_master','pro_stock_master.product_id=products.id AND pro_stock_master.store_id='.$this->store_id);
	    $this->db->join('price_master','price_master.product_id=products.id AND price_master.store_id='.$this->store_id);
