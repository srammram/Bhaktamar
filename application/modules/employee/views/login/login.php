...
<title><?php echo (isset($page_title))?' :: '.$page_title:''; ?></title>
	...
	<body class="owner-page employee_page">
		<?php 
...
<div class="top-content">
	<div class="inner-bg">
		<div class="container">
				<div class="row">
					<div class="logo_employee">
						<a href="#"><img src="<?php echo base_url('assets/admin/dist/img/fms.png')?>"</a>
					</div>
					<div class="owner_box employee_box">
						<div class="border_line_emp">
					  ...
					  <form action="login" method="post">
							<div class="form-group has-feedback">
            					...
            					<span class="form-control-feedback"><div class="remsemployee-user"></div></span>
          					</div>
          					<div class="form-group has-feedback">
							 	<input type="password" name="password" value="" autocomplete="off" class="form-control" placeholder="PASSWORD">
								<span class="form-control-feedback"><div class="remsemployee-pwd"></div></span>
