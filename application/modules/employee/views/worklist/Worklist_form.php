        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><?php echo lang('Worklist_form'); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <form method="post" action="<?php echo site_url('employee/Worklist/worklist_form/'.$id); ?>"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <textarea name="description" autocomplete="off"
                                        class="form-control" readonly><?php if(isset($description)){ echo $description;  }   ?></textarea>
                                </div>
								</div>
								</div>
								  <div class="form-group">
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                    <textarea name="Venue" autocomplete="off"
                                        class="form-control" disabled><?php if(!empty($requestby->permanent_address)){ echo $requestby->permanent_address;  }   ?></textarea>
                                </div>
                            </div>
                        </div>
						 <div class="form-group">
						...
						<div class="form-group">
                              <div class="row">
			                   ...
			                   <option value="<?php echo lang('Accepted'); ?>" <?php if(!empty($status)) echo $status == lang('Accepted') ?'selected':''  ?>><?php echo lang('Accepted'); ?></option>
                                ...
                                <div class="col-md-3">
                                   <input type="text" readonly class="form-control datepicker" autocomplete='off'
