...
<fieldset class="scheduler-border ">
						...
						<div class="col-md-12 feed_back">
							...
							<div class="form-group col-md-12">
								...
								<div class="form-group checkbox_group col-md-3">
								  <input type="checkbox" id="construction_quality" name="construction_quality">
								  <label for="construction_quality">Construction Quality</label>
								</div>
							  	<div class="form-group checkbox_group col-md-3">
								  <input type="checkbox" id="builders_goodwill" name="builders_goodwill">
							...
							<div class="form-group col-md-12">
								...
								<div class="form-group col-md-2">
									<input type="radio" id="very_high" name="price_point">
									<label for="very_high">Very High</label>
								</div>
								<div class="form-group col-md-2">
								  <input type="radio" id="high" name="price_point">
								  <label for="high">High</label>
								</div>
								<div class="form-group col-md-2">
								  <input type="radio" id="fair" name="price_point">
								  <label for="fair">Fair</label>
								</div>
							  <div class="form-group col-md-2">
								  <input type="radio" id="low" name="price_point">
							...
							<div class="form-group col-md-12">
								...
								<div class="form-group col-md-2">
									<input type="radio" id="yes" name="recommand_our_project">
									<label for="yes">Yes</label>
								</div>
								<div class="form-group col-md-2">
								  <input type="radio" id="no" name="recommand_our_project">
						...
						<div class="col-md-12 feed_back">
							...
							<div class="form-group col-md-12">
								...
								<div class="form-group checkbox_group col-md-2">
								  <input type="checkbox" id="pln" name="plan">
								  <label for="pln">Plan</label>
								</div>
								<div class="form-group checkbox_group col-md-2">
								  <input type="checkbox" id="amenit" name="review_amenities">
								  <label for="amenit">Amenities</label>
								</div>
								<div class="form-group checkbox_group col-md-3">
								  <input type="checkbox" id="construction_qty" name="review_construction_qty">
								  <label for="construction_qty">Construction Quality</label>
								</div>
							  	<div class="form-group checkbox_group col-md-3">
								  <input type="checkbox" id="other_text_box" name="other_text_box">
							...
							<div class="form-group col-md-12">
								<label class="col-md-12">2. How Do You Think The Price Point Was ?</label>
								<div class="form-group col-md-2">
									<input type="radio" id="very_hig" name="think_the_price_point_was">
									<label for="very_hig">Very High</label>
								</div>
								<div class="form-group col-md-2">
								  <input type="radio" id="hig" name="radio-group" name="think_the_price_point_was">
								  <label for="hig">High</label>
								</div>
								<div class="form-group col-md-2">
								  <input type="radio" id="fai" name="radio-group" name="think_the_price_point_was">
								  <label for="fai">Fair</label>
								</div>
							  <div class="form-group col-md-2">
								  <input type="radio" id="lo" name="radio-group" name="think_the_price_point_was">
							...
							<div class="form-group col-md-12">
								...
								<div class="form-group col-md-5">
									<textarea rows="3" style="width: 100%;" name="details_reviews"></textarea>
								</div>
