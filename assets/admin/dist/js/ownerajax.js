function getBaseURL() {
	...
	function get_category(str){
		var postUrl  = getBaseURL()+'owner/request/get_category' ;
		if (str == '') {
	...
	function get_subcategory(str){
		var postUrl  = getBaseURL()+'owner/request/get_subcategory' ;
		if (str == '') {
	...
	function get_subcategory_details(str){
		var postUrl  = getBaseURL()+'owner/request/get_subcategory_details' ;
			$.ajax({
				type: "POST",
				url: postUrl,
